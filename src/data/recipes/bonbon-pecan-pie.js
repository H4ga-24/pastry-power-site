const bonbonPecanPie = {
  ...
  steps: [
    { 
      ...
      text: "Infuser vanille dans crème. Cuire sucre et glucose à  185Â°C. Décuire avec crème chaude, sorbitol, sel. Recuire à  106Â°C. Ajouter beurres à  40Â°C. Couler en cadre (4mm)." 
    },
    { 
      title: "Le Praliné Pécan", 
      text: "Réaliser le praliné. Mélanger avec couverture lait et beurre de cacao fondus (26Â°C). Ajouter sablé. Couler sur le caramel (6mm)." 
    },
    { 
      title: "Finition", 
  ...
  advices: [
    "Ne descendez pas la cuisson du caramel sous 105Â°C pour garantir la tenue à  la découpe."
  ],
