const giandujaAmande = {
  ...
  category: "Confiserie",
  subCategory: ["Autres Confiseries"], // Catégorie adaptée
  isVip: false,
  prepTime: "25 MIN",
  cookTime: "15 MIN",
  difficulty: "MOYEN",
  ...
  steps: [
    { 
      title: "Torréfaction", 
      text: "Torréfier les amandes brutes au four à  150Â°C pendant 15 minutes. Laisser refroidir complètement." 
    },
    { 
    ...
    { 
      ...
      text: "Fondre le chocolat au lait (45Â°C). Verser la pâte d'amande sur le chocolat fondu. Mélanger vigoureusement (émulsionner) à  la maryse. Si le mélange est trop sec, ajouter un filet d'huile neutre." 
    },
    { 
      title: "Cristallisation", 
      text: "Verser dans un cadre ou un moule. Laisser cristalliser à  16-18Â°C pendant 24h avant de découper ou d'utiliser." 
    }
  ],

  advices: ["Utilisez des amandes brutes (avec la peau) pour un goà»t plus prononcé."],
