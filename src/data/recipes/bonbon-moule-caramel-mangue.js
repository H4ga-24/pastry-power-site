const bonbonMouleCaramelMangue = {
  ...
  steps: [
    { 
      ...
      text: "Chauffer la crème et la purée de mangue ensemble (sans bouillir). Réaliser un caramel à  sec (couleur blonde) avec le sucre et le glucose. Ne pas trop pousser la couleur pour préserver le goà»t du fruit." 
    },
    { 
      title: "Le Déglaà§age", 
      text: "Déglacer le caramel avec le mélange crème/mangue chaud (attention aux projections). Cuire le tout jusqu'à  106Â°C précisément." 
    },
    { 
      title: "L'Emulsion", 
      text: "Hors du feu, attendre que la température redescende vers 45Â°C, puis incorporer le beurre coupé en dés et émulsionner au mixeur plongeant. Laisser refroidir à  27-28Â°C." 
    },
    { 
      title: "Le Moulage", 
    ...
    { 
      ...
      text: "Pocher le caramel dans les coques (laisser 2mm). Laisser croà»ter 2h. Obturer avec du chocolat lait tempéré." 
    }
  ],

  advices: [
    "La température de 106Â°C est critique : en dessous, le caramel sera trop liquide ; au-dessus, trop dur."
  ],
