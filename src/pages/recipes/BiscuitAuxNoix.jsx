...
const BiscuitAuxNoix = () => {
  ...
  const recipeData = {
    ...
    cookTime: "20 MIN",
    difficulty: "MOYEN",
    description: "Un biscuit riche en fruits secs pour les amateurs de noix, parfait pour les desserts d'automne.",
    image: "https://www.doyoucake.fr/wp-content/uploads/2015/06/g%C3%A9noise-aux-noix-15-810x536.jpg",
  };
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 plaque</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Torréfier légèrement la poudre de noix avant utilisation pour plus de goût.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Bien mixer les noix finement pour éviter les morceaux dans le biscuit.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
