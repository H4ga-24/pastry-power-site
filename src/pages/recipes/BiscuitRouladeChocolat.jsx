...
const BiscuitRouladeChocolat = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit roulade chocolat",
    prepTime: "30 MIN",
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Ce biscuit riche en œufs contenant moins de farine qu'un biscuit traditionnel permet d'augmenter sa flexibilité, il permet donc d'être roulé facilement.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/07/roulage-chocolat.jpg",
  };
  ...
  const ingredients = [
    ...
    { name: 'Cacao en poudre', amount: 30, unit: 'g' },
    { name: 'Sel', amount: 1, unit: 'pincée' },
    { name: 'Crème liquide', amount: 250, unit: 'ml' },
  ...
  const steps = [
    ...
    {
      title: "BLANCHIR.",
      text: "Blanchir les jaunes avec le sucre."
    },
    {
      title: "POUDRES.",
      text: "Incorporer la farine et le cacao."
    },
    {
      title: "MONTER.",
      text: "Monter les blancs en neige."
    },
    {
      title: "MÉLANGE.",
      text: "Incorporer délicatement les blancs au mélange."
    },
    {
      title: "CUISSON.",
      text: "Étaler sur plaque et cuire 10 min à 180°C."
    },
    {
      title: "DÉMOULAGE.",
      text: "Démouler sur linge humide."
    },
    {
      title: "GANACHE.",
      text: "Préparer ganache crème/chocolat."
    },
    {
      title: "FINITION.",
      text: "Garnir et rouler."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Rouler le biscuit encore tiède pour éviter qu'il ne se casse.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Finition</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Saupoudrez de cacao ou nappez de ganache pour la finition.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Un classique indémodable pour les bûches de Noël.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitRouladeChocolat;