...
const PainDepices = () => {
  const recipeData = {
    ...
    cookTime: "55 MIN",
    difficulty: "FACILE",
    description: "Le véritable pain d'épice, riche en miel et aux parfums envoûtants d'épices.",
  ...
  const ingredients = [
    { name: "Miel de châtaignier", amount: "320g" },
    { name: "Farine de seigle", amount: "60g" },
    { name: "Farine T55", amount: "200g" },
    { name: "Oeufs entiers", amount: "55g" },
    { name: "Beurre", amount: "115g" },
    { name: "Lait entier", amount: "135g" },
    { name: "Bicarbonate", amount: "12g" },
    { name: "Cannelle poudre", amount: "6g" },
    { name: "Mélange 4 épices", amount: "3g" },
    { name: "Zestes d'orange", amount: "1/2" }
  ];

  const steps = [
    { title: "Préparation Liquide", text: "Dans une casserole, faire chauffer doucement le miel, le lait et le beurre jusqu'à ce que le beurre soit fondu." },
    { title: "Mélange Sec", text: "Dans un cul-de-poule, mélanger les deux farines, le bicarbonate et les épices." },
    { title: "Assemblage", text: "Verser le mélange liquide chaud sur le mélange sec progressivement en remuant au fouet. Ajouter l'œuf battu et les zestes d'orange." },
    { title: "Repos (Facultatif)", text: "Idéalement, laisser reposer la pâte 24h au frais pour développer les arômes." },
    { title: "Cuisson", text: "Verser dans un moule à cake beurré et fariné. Cuire à 165°C pendant environ 55 minutes." }
  ];
            ...
            <div className="md:col-span-8">
              ...
              <Tabs defaultValue="conseils" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-[#1a1a1a] p-1 h-auto rounded-none border border-white/5">
                  <TabsTrigger value="conseils" className="data-[state=active]:bg-[#D4AF37] data-[state=active]:text-black text-gray-400 py-3 rounded-none uppercase tracking-widest text-xs font-bold transition-all">
                    Conseils
                  </TabsTrigger>
                  <TabsTrigger value="chef" className="data-[state=active]:bg-[#D4AF37] data-[state=active]:text-black text-gray-400 py-3 rounded-none uppercase tracking-widest text-xs font-bold transition-all">
                    Le Mot du Chef
                  </TabsTrigger>
                  <TabsTrigger value="ustensiles" className="data-[state=active]:bg-[#D4AF37] data-[state=active]:text-black text-gray-400 py-3 rounded-none uppercase tracking-widest text-xs font-bold transition-all">
                    Ustensiles
                  </TabsTrigger>
                </TabsList>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>Le miel de châtaignier apporte du caractère, mais vous pouvez utiliser un miel de fleurs pour un goût plus doux.</li>
                           <li>Le pain d'épices est toujours meilleur après quelques jours d'attente, emballé dans du papier aluminium.</li>
                           <li>Pour plus de brillance, badigeonnez le dessus avec un sirop ou de la confiture d'abricot chaude à la sortie du four.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "Ce pain d'épices est une recette de patience. Ne le dégustez pas immédiatement à la sortie du four, laissez-lui le temps de développer ses arômes. C'est un gâteau de voyage par excellence qui se bonifie avec le temps."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-2 text-gray-400">
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Moule à cake 24cm</li>
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Casserole</li>
