...
const MeringueSuisse = () => {
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Mélanger les blancs et le sucre dans un cul de poule." },
    { title: "BAIN-MARIE", text: "Chauffer le mélange au bain-marie jusqu'à 55°C/60°C en fouettant constamment." },
    { title: "FOISONNEMENT", text: "Retirer du feu et monter au batteur à grande vitesse jusqu'à refroidissement complet." },
    { title: "DRESSAGE", text: "Dresser les formes souhaitées sur plaque." },
    { title: "CUISSON", text: "Cuire (sécher) au four à 100°C pendant 1h30 à 2h." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 10 pièces</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Cette meringue est très dense et moins friable que la française.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Se conserve très bien plusieurs semaines dans une boîte hermétique à l'abri de l'humidité.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
