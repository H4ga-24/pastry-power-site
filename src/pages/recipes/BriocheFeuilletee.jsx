...
const BriocheFeuilletee = () => {
  ...
  const recipeData = {
    ...
    description: "Une viennoiserie d'exception mariant le moelleux de la brioche au croustillant du feuilletage.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/08/Brioche-feuilletee.jpg",
  };

  const ingredients = [
    { name: 'Farine de blé', amount: 500, unit: 'g' },
    { name: 'Sucre cassonade', amount: 250, unit: 'g' },
    { name: 'Thé vert (facultatif)', amount: 1, unit: 'g' },
    { name: 'Poudre de lait', amount: 25, unit: 'g' },
    { name: 'Levain', amount: 40, unit: 'g' },
    { name: 'Beurre non salé', amount: 40, unit: 'g' },
    { name: 'Beurre de laminage', amount: 300, unit: 'g' },
    { name: 'Eau', amount: 250, unit: 'ml' }
  ];

  const steps = [
    {
      title: "DÉTREMPE.",
      text: "Préparer la détrempe en pétrissant tous les ingrédients sauf le beurre de laminage."
    },
    {
      title: "INCORPORATION.",
      text: "Incorporer le beurre non salé en fin de pétrissage."
    },
    {
      title: "POINTAGE.",
      text: "Laisser pointer 30 minutes à température ambiante puis réserver au froid."
    },
    {
      title: "TOURAGE.",
      text: "Enchâsser le beurre de laminage et effectuer les tours (3 tours simples ou 1 double et 1 simple)."
    },
    {
      title: "REPOS.",
      text: "Laisser reposer 12 heures à température ambiante (ou au froid contrôlé) pour la fermentation."
    },
    {
      title: "FAÇONNAGE.",
      text: "Détailler et façonner selon la forme désirée (tresses, moules)."
    },
    {
      title: "APPRÊT.",
      text: "Laisser pousser 50 minutes à 28°C."
    },
    {
      title: "FINITION.",
      text: "Badigeonner de sirop à chaud avant cuisson."
    },
    {
      title: "CUISSON.",
      text: "Cuire 25 min à 200°C."
    }
  ];
              ...
              <div className="bg-[#1a1a1a] border border-white/5">
                <Tabs defaultValue="conseils" className="w-full">
                  <TabsList className="w-full flex bg-transparent border-b border-white/10 p-0 h-auto rounded-none">
                    ...
                    <TabsTrigger value="chef" className="flex-1 rounded-none border-b-2 border-transparent data-[state=active]:border-[#D4AF37] data-[state=active]:bg-[#D4AF37]/5 data-[state=active]:text-[#D4AF37] text-gray-500 py-4 text-xs uppercase tracking-widest"><ChefHat className="w-3 h-3 mr-2" />Le Chef</TabsTrigger>
                  </TabsList>
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Patience</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Respecter impérativement les temps de repos pour ne pas déchirer la pâte lors du tourage.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Badigeonner le sirop à chaud juste à la sortie du four pour une brillance incomparable.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Le mot du Chef</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utiliser un beurre de tourage sec à 84% de matière grasse pour un meilleur feuilletage.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BriocheFeuilletee;