...
const MousseForetNoire = () => {
  ...
  const steps = [
    { title: "GANACHE BASE", text: "Verser la crème chaude sur le chocolat haché et émulsionner." },
    { title: "AJOUT CRÈME FROIDE", text: "Ajouter la crème froide et le Kirsch, mélanger." },
    { title: "REPOS", text: "Filmer au contact et laisser reposer au frais au moins 6h (idéalement une nuit)." },
    { title: "MONTAGE", text: "Monter le mélange bien froid au batteur comme une Chantilly jusqu'à texture onctueuse et ferme." },
    { title: "UTILISATION", text: "Garnir immédiatement le gâteau." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 gâteau (20cm)</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le temps de repos est crucial pour que les arômes se diffusent et que la crème monte bien.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Kirsch</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si vous ne voulez pas d'alcool, remplacez-le par du sirop de cerise amarena.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
