...
const SableSpitz = () => {
  ...
  const steps = [
    { title: "CRÉMAGE", text: "Crémer le beurre pommade avec le sucre glace et la vanille jusqu'à obtenir une texture onctueuse." },
    { title: "EMULSION", text: "Ajouter le blanc d'œuf et fouetter vivement pour émulsionner le tout." },
    { title: "FARINE", text: "Incorporer la farine tamisée délicatement à la maryse sans trop travailler la pâte." },
    { title: "POCHAGE", text: "Mettre la pâte dans une poche munie d'une douille cannelée. Dresser des formes de 'W' ou de bâtonnets sur une plaque." },
    { title: "CUISSON", text: "Cuire à 170°C pendant 12 à 15 minutes jusqu'à ce qu'ils soient dorés." },
    { title: "FINITION", text: "Une fois refroidis, tremper la moitié des biscuits dans le chocolat fondu." }
  ];
