...
const CremeChiboust = () => {
  const baseServings = 800; // g
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • CRÈMES",
    title: "La crème Chiboust",
    prepTime: "30 MIN",
    cookTime: "15 MIN",
  ...
  const ingredients = [
    ...
    { name: 'Poudre à crème/Maïzena', amount: 25, unit: 'g' },
  ...
  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Réhydrater la gélatine. Réaliser une crème pâtissière (lait, jaunes, sucre crème, poudre à crème). Incorporer la gélatine hors du feu dans la crème chaude."
    },
    {
      title: "SIROP.",
    ...
    },
    {
      ...
      text: "Monter les blancs. Verser le sirop à 121°C sur les blancs montés et fouetter jusqu'à obtenir une meringue ferme et brillante."
    },
    {
      title: "MÉLANGE FINAL.",
    ...
    {
      title: "UTILISATION.",
      text: "Utiliser immédiatement (dressage à la poche à douille) car la crème prend très vite en refroidissant."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">C'est une crème technique. Il faut coordonner la fin de cuisson de la pâtissière avec la fin du montage de la meringue pour mélanger les deux masses chaudes.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
