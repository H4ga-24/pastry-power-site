...
const MousseMandarine = () => {
  ...
  const steps = [
    ...
    { title: "MÉLANGE", text: "Incorporer la chantilly à la purée gélifiée." },
    { title: "FINITION", text: "Garnir votre entremets." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Infuser quelques zestes dans la crème liquide la veille pour renforcer le goût.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Excellent avec le chocolat noir ou le praliné.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
