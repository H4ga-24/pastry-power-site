...
const MousseMure = () => {
  ...
  const steps = [
    ...
    { title: "MÉLANGE", text: "Incorporer la crème montée à la purée de mûre." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Assurez-vous que la purée soit bien lisse et sans pépins, c'est désagréable sous la dent.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Fonctionne très bien avec une mousse au thé Earl Grey.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
