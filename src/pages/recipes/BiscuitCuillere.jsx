...
const BiscuitCuillere = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "FACILE",
    description: "Les biscuits à la cuillère sont des biscuits secs et moelleux, de forme allongée, saupoudrés de sucre glace.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2021/07/biscuit-a-la-cuillere.jpg",
  };
  ...
  const steps = [
    ...
    {
      title: "DRESSAGE.",
      text: "Dresser à la poche à douille."
    },
    {
      title: "FINITION.",
      text: "Saupoudrer de sucre glace."
    },
    {
      title: "CUISSON.",
      text: "Cuire 10 min à 200°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utiliser une poche à douille lisse pour un beau résultat.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Saupoudrez deux fois de sucre glace à 5 min d'intervalle avant cuisson pour un beau perlage.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Indispensable pour la charlotte aux fraises ou le tiramisu.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
