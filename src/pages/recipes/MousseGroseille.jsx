...
const MousseGroseille = () => {
  ...
  const steps = [
    ...
    { title: "COLLAGE", text: "Ajouter la gélatine essorée. Mélanger avec le reste de purée." },
    { title: "MONTAGE", text: "Monter la crème en chantilly." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème à la purée gélifiée." },
    { title: "FINITION", text: "Couler en moules ou cercles." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Sucre</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La groseille étant très acide, vous pouvez augmenter légèrement la quantité de sucre selon vos goûts.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Se marie très bien avec le chocolat blanc pour adoucir l'acidité.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
