...
const BiscuitDeSavoie = () => {
  ...
  const recipeData = {
    ...
    cookTime: "25 MIN",
    difficulty: "FACILE",
    description: "Un grand classique de la pâtisserie française, ultra léger, aérien et sans matière grasse.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/07/biscuit-de-savoie.png",
  };

  const ingredients = [
    { name: 'Sucre noisette', amount: 150, unit: 'g' },
    { name: 'Oeufs', amount: 150, unit: 'g' },
    { name: 'Farine', amount: 150, unit: 'g' },
    { name: 'Sel', amount: 1, unit: 'pincée' },
    { name: 'Sucre vanillé', amount: 1, unit: 'pincée' },
    { name: 'Sucre glace', amount: 1, unit: 'pincée' }
  ];

  const steps = [
    {
      title: "BLANCHIR.",
      text: "Séparer les blancs des jaunes. Blanchir les jaunes avec le sucre (noisette) jusqu'à ce que le mélange blanchisse et forme un ruban."
    },
    {
      title: "FARINE.",
      text: "Incorporer délicatement la farine tamisée et le sel au mélange jaunes/sucre."
    },
    {
      title: "PARFUM.",
      text: "Ajouter le sucre vanillé."
    },
    {
      title: "BLANCS EN NEIGE.",
      text: "Monter les blancs en neige ferme (avec le sucre glace si souhaité pour serrer). Incorporer délicatement à la préparation précédente."
    },
    {
      title: "CUISSON.",
      text: "Verser dans un moule beurré et fariné. Cuire 25 min à 180°C. Vérifier la cuisson."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Fécule</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour un biscuit encore plus léger, remplacez la moitié de la farine par de la fécule de maïs.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Moule</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Beurrez et sucrez votre moule pour obtenir une croûte délicieusement croustillante.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le secret réside dans le foisonnement des œufs : prenez le temps de bien les monter.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
