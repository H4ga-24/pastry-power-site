...
const MoussePomme = () => {
  ...
  const steps = [
    ...
    { title: "PRÉPARATION", text: "Si vous partez de pommes fraîches, faites une compote bien lisse et mixée. Chauffer une partie." },
    { title: "COLLAGE", text: "Incorporer la gélatine essorée dans la compote chaude. Mélanger avec le reste de compote froide et le Calvados." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Pomme verte</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour plus d'acidité, utilisez de la Granny Smith. Pour plus de douceur, de la Golden.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Caramel</h4>
                      <p className="text-gray-400 font-light leading-relaxed">L'association pomme-caramel beurre salé est un classique indémodable.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
