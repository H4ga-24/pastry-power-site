...
const BiscuitPassionCoco = () => {
  const baseServings = 1;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit passion coco",
    prepTime: "30 MIN",
    cookTime: "40 MIN",
    difficulty: "FACILE",
    description: "Ce biscuit léger et exotique marie parfaitement la délicatesse de la noix de coco et la douceur de la passion. Un équilibre subtil entre textures fondantes et croquantes, idéal pour une bûche aux saveurs tropicales.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2024/09/biscuit-passion-coco.png",
  };

  const ingredients = [
    { name: 'Blancs d\'oeuf', amount: 220, unit: 'g' },
    { name: 'Sucre semoule', amount: 70, unit: 'g' },
    { name: 'Farine type 55', amount: 50, unit: 'g' },
    { name: 'Fécule de pomme de terre', amount: 50, unit: 'g' },
    { name: 'Jaunes d\'oeufs', amount: 140, unit: 'g' },
    { name: 'Oeufs', amount: 60, unit: 'g' },
    { name: 'Sucre semoule (pour jaunes)', amount: 140, unit: 'g' },
    { name: 'Poudre d\'amande', amount: 200, unit: 'g' },
    { name: 'Noix de coco râpée', amount: 60, unit: 'g' },
    { name: 'Purée de noix de coco', amount: 220, unit: 'g' },
    { name: 'Purée de fruit de la passion', amount: 60, unit: 'g' },
    { name: 'Masse obtenue totale', amount: 1270, unit: 'g' }
  ];

  const steps = [
    {
      title: "PRÉPARATION DE LA MERINGUE.",
      text: "Monter les blancs avec la première partie du sucre (70g) pour obtenir une meringue souple mais ferme."
    },
    {
      title: "MÉLANGE DES POUDRES ET LIQUIDES.",
      text: "Mélanger ensuite tous les autres ingrédients : farine, fécule, jaunes d'oeufs, oeufs entiers, la deuxième partie du sucre (140g), poudre d'amande, noix de coco râpée, et les purées de fruits."
    },
    {
      title: "MÉLANGE FINAL.",
      text: "Incorporer délicatement les blancs montés dans le mélange précédent à l'aide d'une maryse, en soulevant la masse pour ne pas faire retomber les blancs."
    },
    {
      title: "CUISSON.",
      text: "Étaler sur un tapis silicone ou une feuille de cuisson (pour une plaque 40x60cm). Cuire à 180°C pendant environ 15 minutes."
    }
  ];
      ...
      <div className="min-h-screen bg-[#121212] text-white font-sans pt-20">
        ...
        <div className="container mx-auto px-4 max-w-6xl pb-24">
          <div className="flex gap-4 mb-16 max-w-4xl ml-auto">
            ...
            <p className="text-gray-300 font-light text-lg italic leading-relaxed pt-4">Pour une feuille de 40 sur 60 cm.</p>
          </div>
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Feuilles (40x60)</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Note du Chef</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ce biscuit est particulièrement moelleux grâce à l'apport de la purée de fruits. Veillez à ne pas trop le cuire pour conserver cette humidité caractéristique.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Astuce de conservation</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Une fois refroidi, ce biscuit peut être filmé et congelé pour une utilisation ultérieure. Il gardera tout son moelleux après décongélation.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitPassionCoco;