...
const BiscuitAmandes = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "FACILE",
    description: "Cette recette permet d'obtenir un biscuit très onctueux et très agréable en goût. Idéal comme base pour de nombreux entremets.",
  ...
  const ingredients = [
    ...
    { name: 'Farine courante', amount: 100, unit: 'g' },
    { name: 'Fécule de pomme de terre', amount: 100, unit: 'g' },
    { name: 'Masse obtenue totale', amount: 1120, unit: 'g' }
  ];

  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Réaliser les pesées."
    },
    {
      title: "DÉTENDRE LA PÂTE D'AMANDE.",
      text: "Détendre la pâte d'amande avec les blancs à la feuille et réserver."
    },
    {
      title: "MONTER LES JAUNES.",
      text: "Monter les jaunes avec le sucre."
    },
    {
      title: "MÉLANGER.",
      text: "Ajouter cette pâte jaune sucre à la masse amande à la Maryse."
    },
    {
      title: "AJOUTER LES POUDRES.",
      text: "Ajouter les poudres (farine et fécule)."
    },
    {
      title: "DRESSER.",
      text: "Dresser sur feuille de papier sulfurisé."
    },
    {
      title: "CUISSON.",
      text: "Cuire à 180°C."
      ...
      <div className="min-h-screen bg-[#121212] text-white font-sans pt-20">
        ...
        <div className="container mx-auto px-4 max-w-6xl pb-24">
          <div className="flex gap-4 mb-16 max-w-4xl ml-auto">
            ...
            <p className="text-gray-300 font-light text-lg italic leading-relaxed pt-4">3 doses permet d'obtenir une feuille de 40 sur 60 cm.</p>
          </div>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Pâte d'amande</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez une pâte d'amande de qualité avec 50% d'amandes minimum pour un goût prononcé et une texture optimale.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Détendre la pâte</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si la pâte d'amande est trop ferme, chauffez-la légèrement au micro-ondes quelques secondes avant de l'incorporer aux blancs d'oeufs.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
