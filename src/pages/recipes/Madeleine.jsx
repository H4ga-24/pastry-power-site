...
const Madeleine = () => {
  ...
  const steps = [
    { title: "BLANCHIR", text: "Fouetter les œufs avec le sucre jusqu'à ce que le mélange blanchisse." },
    { title: "LIQUIDES", text: "Ajouter le lait et le zeste de citron." },
    { title: "SECS", text: "Incorporer la farine et la levure tamisées." },
    { title: "BEURRE", text: "Ajouter le beurre fondu et tiédi. Mélanger jusqu'à obtenir une pâte lisse." },
    { title: "REPOS (IMPORTANT)", text: "Laisser reposer la pâte au réfrigérateur pendant au moins 2 heures (idéalement une nuit). C'est le choc thermique qui crée la bosse." },
    { title: "DRESSAGE", text: "Beurrer et fariner les moules à madeleines (sauf si silicone). Remplir les empreintes aux 3/4." },
    { title: "CUISSON", text: "Enfourner à four très chaud (220°C) pendant 4-5 minutes, puis baisser à 180°C pour finir la cuisson (environ 5-6 min)." }
  ];
