...
const CakeAnchoisTomate = () => {
  const ingredients = [
    ...
    { name: "Filets d'anchois", amount: "100g" },
    { name: "Tomates", amount: "2" },
    { name: "Olives noires", amount: "50g" },
    { name: "Huile (garniture)", amount: "15g" },
    { name: "Poivre", amount: "2 pincées" }
  ];

  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake Anchois Tomates - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake Anchois Tomate" src="https://www.torchonsetserviettes.fr/wp-content/uploads/2020/11/cake5-scaled.jpg" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake Anchois, Tomates & Olives</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Épépinez les tomates et coupez-les en dés. Coupez les anchois en morceaux et les olives en rondelles.</p>
              ...
              <p><span className="text-[#D4AF37] font-bold">3.</span> Ajoutez les œufs, les 100g d'huile et le lait. Mélangez bien.</p>
              <p><span className="text-[#D4AF37] font-bold">4.</span> Incorporez le gruyère, les dés de tomates, les anchois et les olives. Ajoutez les 15g d'huile supplémentaires. Poivrez (ne pas saler).</p>
