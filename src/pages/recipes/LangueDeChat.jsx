...
const LangueDeChat = () => {
  ...
  const steps = [
    { title: "CRÉMAGE", text: "Travailler le beurre mou avec le sucre glace jusqu'à obtenir une pommade." },
    { title: "FARINE", text: "Ajouter la farine tamisée et la vanille." },
    { title: "BLANCS", text: "Incorporer les blancs d'œufs petit à petit en fouettant bien pour obtenir une pâte lisse." },
    { title: "POCHAGE", text: "Dresser des bâtonnets de 6cm de long, bien espacés, à la poche à douille lisse (n°8)." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 8 à 10 minutes. Les bords doivent être bien dorés et le centre pâle." }
  ];
