...
const BiscuitMadeleineOrange = () => {
  const baseServings = 1;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit Madeleine Orange",
    prepTime: "20 MIN",
    cookTime: "12 MIN",
    difficulty: "FACILE",
    description: "Un biscuit tendre et parfumé aux zestes d'orange, inspiré de la madeleine.",
    image: "https://mapatisserie.fr/wp-content/uploads/2024/02/recette-madeleine-01-275x275.jpg",
  };

  const ingredients = [
    { name: 'Oeufs', amount: 3, unit: 'pièces' },
    { name: 'Sucre', amount: 130, unit: 'g' },
    { name: 'Farine', amount: 150, unit: 'g' },
    { name: 'Levure chimique', amount: 5, unit: 'g' },
    { name: 'Beurre fondu', amount: 125, unit: 'g' },
    { name: 'Zeste d\'orange', amount: 1, unit: 'pièce' }
  ];

  const steps = [
    { title: "PRÉPARATION", text: "Faire fondre le beurre et laisser tiédir." },
    { title: "MÉLANGE", text: "Fouetter les oeufs et le sucre jusqu'à blanchiment." },
    { title: "ARÔMES", text: "Ajouter les zestes d'orange." },
    { title: "POUDRES", text: "Incorporer la farine et la levure tamisées, puis le beurre fondu." },
    { title: "REPOS & CUISSON", text: "Laisser reposer 1h au frais. Cuire à 200°C environ 10-12 minutes." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 20 madeleines</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le choc thermique est important pour la bosse.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Parfum</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Peut être remplacé par du citron ou de la vanille.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitMadeleineOrange;