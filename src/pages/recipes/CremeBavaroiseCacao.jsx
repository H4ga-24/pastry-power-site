...
const CremeBavaroiseCacao = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Une bavaroise intense en goût chocolaté grâce à l'utilisation de cacao en poudre amer de haute qualité.",
  ...
  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Mélanger le cacao en poudre avec une partie du sucre. Faire chauffer le lait."
    },
    {
      title: "ANGLAISE CACAO.",
      text: "Fouetter les jaunes avec le reste du sucre. Ajouter le mélange sucre/cacao. Verser le lait chaud dessus, mélanger et cuire à la nappe (83°C)."
    },
    {
      title: "GÉLATINE.",
      text: "Ajouter la gélatine réhydratée hors du feu. Mixer si nécessaire pour bien lisser le cacao."
    },
    {
      title: "REFROIDISSEMENT.",
      text: "Laisser refroidir jusqu'à légère prise (25°C-30°C)."
    },
    {
      title: "MONTAGE.",
      text: "Incorporer délicatement la crème fouettée à la maryse."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le cacao a tendance à "sécher" la préparation. Veillez à ne pas trop cuire l'anglaise et à bien hydrater la gélatine pour garder du moelleux.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
