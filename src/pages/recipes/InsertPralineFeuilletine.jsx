...
const InsertPralineFeuilletine = () => {
  ...
  const steps = [
    { title: "FONTE", text: "Faire fondre le chocolat au lait au bain-marie (ou micro-ondes par tranches de 30s)." },
    { title: "MÉLANGE", text: "Mélanger le chocolat fondu avec le praliné noisette." },
    { title: "AJOUTS", text: "Incorporer la feuilletine émiettée et la fleur de sel délicatement." },
    { title: "ÉTALAGE", text: "Étaler la préparation entre deux feuilles de papier cuisson ou dans le fond d'un cercle." },
    { title: "CRISTALLISATION", text: "Laisser prendre au réfrigérateur ou congélateur avant montage." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Épaisseur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Visez une épaisseur de 3 à 4 mm pour ne pas rendre la dégustation difficile.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez utiliser du chocolat noir pour un résultat moins sucré, ou du chocolat blanc pour plus de douceur.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
