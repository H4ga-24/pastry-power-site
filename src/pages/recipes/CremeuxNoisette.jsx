...
const CremeuxNoisette = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Un crémeux ultra-gourmand au goût profond de noisette torréfiée, apporté par un praliné de qualité.",
  ...
  const ingredients = [
    ...
    { name: 'Sucre', amount: 20, unit: 'g' },
    { name: 'Praliné noisette 60%', amount: 120, unit: 'g' },
    { name: 'Gélatine', amount: 3, unit: 'g' }
  ];

  const steps = [
    { title: "Préparation", text: "Hydrater la gélatine. Préparer le praliné dans un bol haut." },
    { title: "Cuisson Anglaise", text: "Chauffer le lait et la crème. Fouetter les jaunes et le sucre. Cuire le tout à la nappe (83°C)." },
    { title: "Mélange", text: "Hors du feu, ajouter la gélatine. Verser la crème anglaise chaude sur le praliné noisette." },
    { title: "Emulsion", text: "Mixer immédiatement au mixeur plongeant pour créer une émulsion parfaite et lisse." },
    { title: "Finition", text: "Couler en insert ou utiliser en pochage après 12h de cristallisation au réfrigérateur." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Praliné</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le choix du praliné est crucial. Un praliné artisanal à 60% de fruits minimum garantit un goût puissant et moins sucré.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Texture</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si vous souhaitez une texture plus ferme pour un entremets, augmentez la gélatine à 4g.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
