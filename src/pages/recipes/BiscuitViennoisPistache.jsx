...
const BiscuitViennoisPistache = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit viennois pistache",
    prepTime: "20 MIN",
    cookTime: "25 MIN",
    difficulty: "MOYEN",
    description: "Un biscuit viennois moelleux et riche, sublimé par la saveur de la pistache.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2024/09/IMG_20240531_101039-768x1024-1.jpg",
  };

  const ingredients = [
    { name: 'Beurre Emul', amount: 100, unit: 'g' },
    { name: 'Sucre noisette', amount: 100, unit: 'g' },
    { name: 'Sucre Cassonade', amount: 50, unit: 'g' },
    { name: 'Sucre Emul', amount: 80, unit: 'g' },
    { name: 'Sucre noisette', amount: 100, unit: 'g' },
    { name: 'Glaçage sel', amount: 67, unit: 'g' },
    { name: 'Farine type 55', amount: 65, unit: 'g' },
    { name: 'Farine de pomme de terre', amount: 75, unit: 'g' },
    { name: 'Pistache moulue', amount: 75, unit: 'g' },
  ...
  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Mélanger les pistaches pour obtenir une poudre fine si ce n'est pas déjà fait."
    },
    {
      title: "CUISSON DU SUCRE.",
      text: "Mélanger une cuillère de sucre et porter à 180° (caramel) si nécessaire pour le praliné ou l'appareil, selon la technique spécifique."
    },
    {
      title: "MÉLANGE DES POUDRES.",
      text: "Incorporer la farine tamisée avec la farine de pomme de terre et les pistaches moulues."
    },
    {
      title: "MOULAGE.",
      text: "Verser l'appareil dans un moule ou sur une plaque recouverte de papier cuisson."
    },
    {
      title: "CUISSON.",
      text: "Cuire 25 min au four préchauffé."
    },
    {
      title: "FINITION.",
      text: "Démouler sur grille et laisser refroidir avant utilisation."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Pistaches</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez des pistaches de qualité (ex: Bronte ou Iran) pour une couleur et un goût incomparables.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Surveillez la coloration, le biscuit doit rester tendre.</p>
                    </TabsContent>
                     <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ce biscuit apporte une texture fondante idéale pour les entremets aux fruits rouges.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitViennoisPistache;