...
const InsertGelifieAuxFruits = () => {
  ...
  const steps = [
    { title: "HYDRATATION", text: "Faire tremper la gélatine dans un grand volume d'eau froide." },
    { title: "CHAUFFE", text: "Chauffer un tiers de la purée de fruits avec le sucre jusqu'à dissolution." },
    { title: "INCORPORATION", text: "Hors du feu, ajouter la gélatine essorée et mélanger." },
    { title: "MÉLANGE", text: "Verser ce mélange sur le reste de purée froide et le jus de citron. Mélanger." },
    { title: "COULAGE", text: "Couler dans le moule insert et bloquer au grand froid (congélateur)." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez utiliser de la pectine NH nappage à la place de la gélatine pour une texture plus fondante.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des morceaux de fruits frais coupés en dés dans la préparation avant congélation.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
