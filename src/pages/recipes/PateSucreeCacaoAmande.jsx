...
const PateSucreeCacaoAmande = () => {
  const baseServings = 10;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • PÂTES",
    title: "Pâte sucrée cacao amande",
    prepTime: "10 MIN",
    cookTime: "20 MIN",
    difficulty: "FACILE",
    description: "Une base parfaite pour les tartes au chocolat, alliant le croquant de la pâte sucrée à l'intensité du cacao.",
    image: "https://empreintesucree.fr/wp-content/uploads/2016/11/1-pate-sucree-chocolat-recette-patisserie-empreinte-sucree.jpg",
  };

  const ingredients = [
    { name: 'Beurre pommade', amount: 180, unit: 'g' },
    { name: 'Sucre glace', amount: 110, unit: 'g' },
    { name: 'Oeuf', amount: 80, unit: 'g' },
    { name: 'Sel fin', amount: 1, unit: 'g' },
    { name: 'Farine type 55', amount: 250, unit: 'g' },
    { name: 'Cacao poudre', amount: 40, unit: 'g' },
  ...
  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Tamiser ensemble la farine, le cacao et la poudre d'amande."
    },
    {
      title: "CRÉMAGE.",
      text: "Dans la cuve du batteur, blanchir le beurre pommade avec le sucre glace et le sel."
    },
    {
      title: "ÉMULSION.",
      text: "Ajouter l'oeuf et émulsionner vivement."
    },
    {
      title: "MÉLANGE FINAL.",
      text: "Incorporer le mélange de poudres et mélanger brièvement jusqu'à l'obtention d'une pâte homogène sans corser."
    },
    {
      title: "REPOS.",
      text: "Former une boule, filmer et laisser reposer 1h au froid."
    },
    {
      title: "FONÇAGE.",
      text: "Étaler la pâte sur 3mm d'épaisseur et foncer les cercles."
    },
    {
      title: "CUISSON.",
      text: "Cuire à blanc ou avec garniture selon la recette finale."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Organisation</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez mixer farine et sucre ensemble et réserver au froid avant utilisation pour une meilleure texture.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Fonçage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Assurez-vous que la pâte est bien froide lors du fonçage pour éviter qu'elle ne se rétracte.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'amande apporte du moelleux qui balance parfaitement l'amertume du cacao.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default PateSucreeCacaoAmande;