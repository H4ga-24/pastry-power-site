...
const CremeuxShisoVert = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Une création originale aux notes herbacées et poivrées caractéristiques du shiso, parfaite pour accompagner des agrumes ou des fruits rouges.",
  ...
  const ingredients = [
    ...
    { name: 'Feuilles de Shiso vert', amount: 15, unit: 'pcs' },
    { name: 'Jaunes d\'œufs', amount: 80, unit: 'g' },
    { name: 'Sucre semoule', amount: 40, unit: 'g' },
    { name: 'Chocolat blanc 33%', amount: 120, unit: 'g' },
    { name: 'Gélatine', amount: 3, unit: 'g' }
  ];

  const steps = [
    { title: "Infusion", text: "Chauffer le lait et la crème. Ajouter les feuilles de shiso ciselées. Filmer et laisser infuser 20 min." },
    { title: "Filtration", text: "Chinoiser en pressant bien les feuilles pour extraire le maximum d'arômes. Compléter au poids avec du lait si nécessaire." },
    { title: "Cuisson", text: "Réaliser une anglaise : verser le liquide chaud sur le mélange jaunes/sucre, cuire à 83°C." },
    { title: "Mélange", text: "Incorporer la gélatine hydratée. Verser sur le chocolat blanc." },
    { title: "Emulsion", text: "Mixer pour lisser et homogénéiser." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Accords</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le shiso se marie très bien avec la fraise, la framboise, le pamplemousse ou le yuzu.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Shiso rouge</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le shiso rouge est moins parfumé et sert plus souvent pour la couleur. Préférez le vert pour cette recette.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
