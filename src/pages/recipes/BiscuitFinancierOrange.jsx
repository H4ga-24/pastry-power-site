...
const BiscuitFinancierOrange = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit financier à l'orange",
    prepTime: "20 MIN",
    cookTime: "15 MIN",
    difficulty: "FACILE",
    description: "Onctueux et souple ce biscuit permet de réaliser de superbes base d'entremets et des petits fours.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2021/09/biscuit-fiancier.jpg",
  };

  const ingredients = [
    { name: 'Beurre emulsé', amount: 300, unit: 'g' },
    { name: 'Poudre d\'amande', amount: 150, unit: 'g' },
    { name: 'Farine cacao', amount: 150, unit: 'g' },
    { name: 'Jaunes d\'oeuf', amount: 3, unit: 'pcs' },
    { name: 'Jus d\'orange', amount: 75, unit: 'ml' },
  ...
  const steps = [
    {
      title: "MÉLANGE SEC.",
      text: "Mélanger la poudre d'amande et la farine."
    },
    {
      title: "BEURRE.",
      text: "Incorporer le beurre emulsé."
    },
    {
      title: "JAUNES.",
      text: "Ajouter les jaunes."
    },
    {
      title: "JUS.",
      text: "Verser le jus d'orange."
    },
    {
      title: "BLANCS.",
    ...
    {
      title: "MÉLANGE FINAL.",
      text: "Incorporer délicatement."
    },
    {
      title: "CUISSON.",
      text: "Cuire 15 min à 200°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utiliser du jus d'orange frais pour plus de saveur.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Se conserve très bien plusieurs jours dans une boîte hermétique.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'orange apporte une fraîcheur bienvenue au riche goût de l'amande.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitFinancierOrange;