...
const LaPateSablee = () => {
  ...
  const ingredients = [
    ...
    { name: 'Beurre allégé (ou beurre)', amount: 40, unit: 'g' }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le sablage permet d'imperméabiliser la farine avec le gras, ce qui limite le développement du gluten et assure la friabilité.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Ordre</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Les éléments liquides (oeufs) sont toujours ajoutés à la fin dans cette méthode.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez du sucre cassonade pour apporter plus de croquant et un léger goût caramélisé.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
