...
const InsertCaramelMoelleuxFleurDeSel = () => {
  ...
  const steps = [
    { title: "CUISSON", text: "Cuire le sucre, le glucose et un peu d'eau à 185°C (caramel foncé)." },
    { title: "DÉCUISSON", text: "Ajouter la crème chauffée avec la vanille, faire attention aux éclaboussures." },
    { title: "RECUISSON", text: "Cuire l'ensemble à 118°C pour obtenir la texture 'moelleuse'." },
    { title: "EMULSION", text: "Laisser refroidir à 70°C puis ajouter le beurre et la fleur de sel. Émulsionner." },
    { title: "COULAGE", text: "Couler dans les inserts. Ce caramel reste souple même congelé." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Thermomètre</h4>
                      <p className="text-gray-400 font-light leading-relaxed">L'utilisation d'un thermomètre à sucre est indispensable pour la réussite de la texture.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Cet insert peut être préparé des semaines à l'avance et conservé au congélateur.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
