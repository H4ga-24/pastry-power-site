...
const BiscuitMoelleux = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit moelleux",
    prepTime: "25 MIN",
    cookTime: "25 MIN",
    difficulty: "FACILE",
    description: "Un biscuit chocolat moelleux idéal pour les entremets.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2023/02/Feuille-biscuit-Genoise-1300x852.jpg",
  };

  const ingredients = [
    { name: 'Beurre', amount: 270, unit: 'g' },
    { name: 'Chocolat de couverture noir', amount: 450, unit: 'g' },
    { name: 'Jaunes d\'oeuf', amount: 200, unit: 'g' },
    { name: 'Blancs d\'oeuf', amount: 450, unit: 'g' },
    { name: 'Sucre semoule', amount: 270, unit: 'g' },
    { name: 'Farine cacao', amount: 75, unit: 'g' }
  ];

  const steps = [
    {
      title: "FONTE.",
      text: "Faire fondre le chocolat et le beurre."
    },
    {
      title: "MÉLANGE JAUNES.",
      text: "Mélanger les jaunes avec le sucre."
    },
    {
      title: "CHOCOLAT.",
      text: "Incorporer le chocolat fondu."
    },
    {
      title: "BLANCS.",
      text: "Monter les blancs avec le sucre."
    },
    {
      title: "INCORPORATION.",
    ...
    {
      title: "POUDRES.",
      text: "Ajouter la farine cacao."
    },
    {
      title: "CUISSON.",
      text: "Cuire 25 min à 180°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ce biscuit doit rester moelleux à coeur, ne pas trop cuire.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Usage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Parfait pour les montages d'entremets multi-couches.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La richesse du chocolat de couverture apporte une texture unique.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitMoelleux;