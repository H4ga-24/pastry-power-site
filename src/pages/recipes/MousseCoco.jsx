...
const MousseCoco = () => {
  ...
  const steps = [
    { title: "GÉLATINE", text: "Faire tremper la gélatine dans l'eau froide." },
    { title: "CHAUFFE", text: "Chauffer une partie de la purée de coco." },
    { title: "COLLAGE", text: "Incorporer la gélatine essorée dans la purée chaude. Mélanger avec le reste de purée froide et la liqueur." },
    { title: "MONTAGE", text: "Monter la crème en chantilly souple." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème montée à la purée gélifiée refroidie." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez un peu de noix de coco râpée torréfiée pour le croquant.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Accord</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Se marie parfaitement avec un insert ananas ou fruit de la passion.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
