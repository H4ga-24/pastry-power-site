...
const MousseMangue = () => {
  ...
  const steps = [
    ...
    { title: "COLLAGE", text: "Ajouter la gélatine essorée. Mélanger avec le reste de purée froide et le citron." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Préférez les mangues Alphonso pour leur parfum intense.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le citron vert est indispensable pour "casser" le côté très sucré de la mangue.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
