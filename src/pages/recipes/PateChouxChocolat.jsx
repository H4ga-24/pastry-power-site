...
const PateChouxChocolat = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • PÂTES",
    title: "Pâte à choux chocolat lissé au sucre inverti",
    prepTime: "40 MIN",
    cookTime: "25 MIN",
    difficulty: "MOYEN",
    description: "Une pâte à choux sophistiquée, colorée au chocolat et sublimée par un glaçage brillant au sucre inverti.",
    image: "https://cuisinedaubery.com/wp-content/uploads/2024/04/pate_a_choux_ALTERN09.jpg",
  };

  const ingredients = [
    { name: 'Eau', amount: 250, unit: 'ml' },
    { name: 'Beurre', amount: 100, unit: 'g' },
    { name: 'Farine type 55', amount: 150, unit: 'g' },
    { name: 'Oeufs', amount: 4, unit: 'pcs' },
    { name: 'Sel', amount: 1, unit: 'pincée' },
    { name: 'Sucre', amount: 1, unit: 'pincée' },
    { name: 'Chocolat de couverture', amount: 200, unit: 'g' },
    { name: 'Sucre inverti', amount: 100, unit: 'g' }
  ];

  const steps = [
    {
      title: "ÉBULLITION.",
      text: "Dans une casserole, porter l'eau, le beurre, le sel et le sucre à ébullition."
    },
    {
      title: "FARINE.",
      text: "Retirer du feu et incorporer la farine en une seule fois. Mélanger vivement."
    },
    {
      title: "DESSÈCHEMENT.",
      text: "Remettre sur le feu et dessécher la pâte jusqu'à ce qu'elle se décolle des parois."
    },
    {
      title: "REFROIDISSEMENT.",
      text: "Laisser refroidir légèrement la panade."
    },
    {
      title: "OEUFS.",
      text: "Incorporer les oeufs un à un en mélangeant bien entre chaque ajout jusqu'à obtenir le ruban."
    },
    {
      title: "DRESSAGE.",
      text: "Dresser les choux à la poche à douille sur plaque graissée."
    },
    {
      title: "CUISSON.",
    ...
    {
      title: "GLAÇAGE.",
      text: "Préparer le glaçage en faisant fondre le chocolat et en y ajoutant le sucre inverti."
    },
    {
      title: "FINITION.",
      text: "Lisser les choux refroidis avec le glaçage."
    }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Personnes</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Bien dessécher la pâte pour une meilleure tenue à la cuisson.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utiliser le sucre inverti pour un glaçage brillant, lisse et qui ne cristallise pas.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le sucre inverti est l'allié des professionnels pour des finitions parfaites.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default PateChouxChocolat;