...
const CrumbleAmande = () => {
  ...
  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Mélanger les ingrédients secs (farine, sucre, poudre d'amande, sel) ensemble."
    },
    {
      title: "SABLAGE.",
      text: "Ajouter le beurre froid coupé en dés et sabler le mélange jusqu'à obtenir une texture grumeleuse grossière."
    },
    {
      title: "CUISSON.",
      text: "Étaler sur plaque et cuire 30 min à 180°C jusqu'à coloration dorée."
    },
    {
      title: "UTILISATION.",
      text: "Utiliser comme base ou saupoudrer sur des fruits ou crèmes."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Mélange</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Mélanger votre poudre d'amande avec votre sucre pour une meilleure incorporation et éviter les grumeaux.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le crumble cru se congèle très bien. Vous pouvez en préparer d'avance et le sortir au besoin.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Une touche de fleur de sel rehausse merveilleusement le goût de l'amande.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
