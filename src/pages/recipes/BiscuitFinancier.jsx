...
const BiscuitFinancier = () => {
  const baseServings = 1;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit Financier",
    prepTime: "20 MIN",
    cookTime: "15 MIN",
    difficulty: "FACILE",
    description: "Un grand classique à base de poudre d'amande et de beurre noisette, moelleux à cœur.",
    image: "https://mapatisserie.fr/wp-content/uploads/2024/02/recette-financier-01-275x275.jpg",
  };
  ...
  const steps = [
    { title: "BEURRE NOISETTE", text: "Réaliser un beurre noisette et le laisser tiédir." },
    { title: "MÉLANGE SEC", text: "Mélanger le sucre glace, la poudre d'amande et la farine." },
    { title: "BLANCS", text: "Ajouter les blancs d'oeufs non montés aux poudres." },
    { title: "FINITION", text: "Incorporer le beurre noisette filtré." },
    { title: "CUISSON", text: "Cuire à 190°C pendant 12 à 15 minutes." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 12 financiers</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le beurre noisette apporte ce goût caractéristique incomparable.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Remplacer la poudre d'amande par de la noisette ou de la pistache.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitFinancier;