...
const LesPalaisDesDames = () => {
  ...
  const ingredients = [
    ...
    { name: 'Confiture d\'abricot (nappage)', amount: 100, unit: 'g' },
    { name: 'Sucre glace (glaçage)', amount: 100, unit: 'g' },
    { name: 'Eau ou Kirsch (glaçage)', amount: 20, unit: 'ml' }
  ];

  const steps = [
    { title: "PÂTE", text: "Crémer le beurre et le sucre. Ajouter les œufs puis la farine. La pâte doit être lisse." },
    { title: "DRESSAGE", text: "Dresser des palets ronds sur une plaque à la poche à douille." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 10 à 12 minutes. Ils doivent rester pâles." },
    { title: "NAPPAGE", text: "À la sortie du four, badigeonner finement de confiture d'abricot chaude." },
    { title: "GLAÇAGE", text: "Mélanger le sucre glace avec le liquide. Napper les biscuits refroidis avec ce glaçage." }
  ];
