...
const BatonMarechaux = () => {
  ...
  const updateServings = (change) => {
    ...
    if (newServings >= 5) setServings(newServings);
  };
  ...
  const steps = [
    {
      ...
      text: "Monter les blancs d'œufs en neige. Lorsqu'ils commencent à mousser, incorporer le sucre semoule progressivement jusqu'à obtenir une meringue ferme, lisse et brillante (bec d'oiseau)."
    },
    {
      title: "Mélange des fruits secs",
      text: "Incorporer délicatement à la maryse les amandes et noisettes hachées (préalablement torréfiées pour plus de goût) ainsi que la vanille. Le mélange doit rester aérien."
    },
    {
      title: "Dressage",
      text: "Mettre l'appareil en poche avec une douille lisse de 10mm. Dresser des bâtonnets réguliers de 6 à 7 cm de long sur une plaque recouverte de papier cuisson."
    },
    {
      title: "Cuisson",
      text: "Enfourner à 160°C pendant 12 à 15 minutes. Les biscuits doivent être secs au toucher et arborer une coloration très légèrement dorée."
    },
    {
      title: "Finitions au chocolat",
      text: "Après complet refroidissement, tempérer le chocolat noir. Tremper la base ou les deux extrémités de chaque bâtonnet dans le chocolat fondu. Laisser figer sur grille."
    }
  ];
  ...
  const structuredData = {
    ...
    "keywords": "bâtons maréchaux, petits fours secs, amande, noisette, chocolat",
              ...
              <div className="bg-[#1a1a1a] p-8 rounded-sm border border-white/5 sticky top-24">
                <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-6">
                  <div className="flex items-center gap-2 text-[#D4AF37]">
                    ...
                    <span className="font-serif text-lg">Quantité</span>
                  </div>
                  <div className="flex items-center gap-4 bg-[#252525] rounded-full px-2 py-1">
                    <Button variant="ghost" size="icon" onClick={() => updateServings(-5)} className="text-white hover:text-[#D4AF37] h-8 w-8 rounded-full">
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                          Passez vos amandes et noisettes hachées 10 minutes au four à 150°C avant de les incorporer. Cela décuple les arômes et garantit un croquant exceptionnel.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "Veillez à ce que vos blancs soient parfaitement montés. Si la meringue est trop liquide, les bâtons vont s'étaler à la cuisson et perdre leur relief caractéristique."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
