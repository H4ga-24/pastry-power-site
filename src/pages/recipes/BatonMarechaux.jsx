...
const BatonMarechaux = () => {
  ...
  const recipeData = {
    ...
    title: "Bâton maréchaux",
    prepTime: "30 MIN",
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Des biscuits croquants aux amandes et noisettes grillées, souvent trempés dans le chocolat.",
  ...
  const steps = [
    { title: "MONTAGE", text: "Monter les blancs d'œufs en neige ferme en incorporant le sucre progressivement pour obtenir une meringue." },
    { title: "MÉLANGE SEC", text: "Incorporer délicatement les amandes, les noisettes hachées et la vanille à la meringue." },
    { title: "DRESSAGE", text: "Dresser à la poche à douille (douille lisse 10mm) des bâtonnets de 6-7 cm de long sur une plaque chemisée." },
    { title: "CUISSON", text: "Cuire à 160°C pendant environ 10 à 15 minutes. Ils doivent être bien secs et légèrement dorés." },
    { title: "FINITION", text: "Laisser refroidir. Faire fondre le chocolat noir et tremper les extrémités ou le dessous des bâtons." }
  ];
