...
const MeringueItalienne = () => {
  ...
  const steps = [
    { title: "SIROP", text: "Cuire le sucre et l'eau dans une casserole jusqu'à 118°C/121°C." },
    { title: "BLANCS", text: "Commencer à monter les blancs quand le sirop atteint 110°C." },
    { title: "VERSAGE", text: "Verser le sirop bouillant en filet sur les blancs tout en fouettant à vitesse moyenne." },
    { title: "FOISONNEMENT", text: "Augmenter la vitesse et fouetter jusqu'à refroidissement complet de la meringue (environ 30-35°C)." },
    { title: "UTILISATION", text: "Utiliser immédiatement pour macaronner, garnir ou décorer." }
  ];
      ...
      <div className="min-h-screen bg-[#121212] text-white font-sans pt-20">
        <div className="relative h-[60vh] w-full overflow-hidden">
          ...
          <div className="absolute top-24 left-4 md:left-8 z-30">
             <Link to="/patisserie/bases/mousses">
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 bol</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Attention aux projections de sirop chaud. Versez-le sur le bord de la cuve.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Utilisation</h4>
                      <p className="text-gray-400 font-light leading-relaxed">C'est la meringue la plus stable, parfaite pour les décors à la poche.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
