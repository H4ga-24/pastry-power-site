...
const MoussePapaye = () => {
  ...
  const steps = [
    ...
    { title: "COLLAGE", text: "Ajouter la gélatine essorée. Mélanger avec le reste de purée et le citron vert." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Citron</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La papaye a un goût assez plat, le citron vert est indispensable pour le "peps".</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Pour une texture plus lisse, passez la purée au tamis fin.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
