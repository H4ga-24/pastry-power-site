...
const CremeChantilly = () => {
  ...
  const steps = [
    ...
    {
      title: "DÉMARRAGE.",
      text: "Verser la crème froide dans le bol. Fendre la gousse de vanille et ajouter les graines. Commencer à fouetter à vitesse moyenne."
    },
    {
      title: "FOISONNEMENT.",
    ...
    {
      title: "SERRAGE.",
      text: "Augmenter légèrement la vitesse pour 'serrer' la chantilly jusqu'à obtenir une consistance ferme mais onctueuse."
    },
    {
      title: "FINITION.",
      text: "Arrêter immédiatement dès que la texture est atteinte pour éviter de transformer la crème en beurre."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Matière Grasse</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Il est impératif d'utiliser une crème à 30% ou 35% de matière grasse minimum. La crème légère ne montera jamais en chantilly.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
