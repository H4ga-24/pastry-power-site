...
const CremeuxVerveine = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Une fraîcheur citronnée très élégante grâce à la verveine fraîche, idéale pour des desserts d'été légers.",
  ...
  const steps = [
    { title: "Infusion", text: "Chauffer le lait et la crème. Ajouter les feuilles de verveine. Laisser infuser 30 min à couvert." },
    { title: "Filtration", text: "Chinoiser et presser. Réajuster le poids du liquide." },
    { title: "Cuisson", text: "Cuire à l'anglaise (83°C) avec les jaunes et le sucre." },
    { title: "Collage", text: "Ajouter la gélatine essorée. Verser sur le chocolat blanc." },
    { title: "Emulsion", text: "Mixer soigneusement." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez toujours de la verveine fraîche. La verveine séchée a un goût plus "tisane" et terreux.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Couleur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour renforcer la couleur verte naturellement, mixez quelques feuilles de verveine blanchies dans la crème avant de filtrer.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
