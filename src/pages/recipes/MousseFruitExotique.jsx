...
const MousseFruitExotique = () => {
  ...
  const steps = [
    { title: "GÉLATINE", text: "Réhydrater la gélatine dans un grand volume d'eau froide." },
    { title: "CHAUFFE", text: "Chauffer un tiers de la purée de fruits exotiques avec le sucre." },
    { title: "INCORPORATION", text: "Hors du feu, ajouter la gélatine essorée. Mélanger puis verser le reste de la purée froide." },
    { title: "MONTAGE", text: "Monter la crème liquide en chantilly souple (baveuse)." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème montée à la purée gélifiée (quand elle est à environ 25°C)." },
    { title: "FINITION", text: "Couler immédiatement dans vos moules ou verrines." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Idéale en insert dans un entremets chocolat au lait.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des dés de mangue fraîche pour plus de mâche.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
