...
const MousseLitchi = () => {
  ...
  const steps = [
    ...
    { title: "CHAUFFE", text: "Chauffer 1/3 de la purée avec le sucre." },
    { title: "COLLAGE", text: "Incorporer la gélatine essorée. Mélanger avec le reste de purée froide." },
    { title: "MONTAGE", text: "Monter la crème en chantilly souple." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème à la base litchi." },
    { title: "FINITION", text: "Couler en moules." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Quelques gouttes d'eau de rose subliment le goût du litchi.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des morceaux de litchi égouttés pour la mâche.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
