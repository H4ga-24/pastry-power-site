...
const MoelleuxChocolat = () => {
  ...
  const ingredients = [
    { name: "Chocolat noir 65%", amount: "200g" },
    { name: "Beurre", amount: "150g" },
    { name: "Sucre", amount: "100g" },
    { name: "Oeufs", amount: "4" },
    { name: "Farine", amount: "50g" }
  ];

  const steps = [
    { title: "Fonte", text: "Faire fondre le chocolat et le beurre ensemble au bain-marie ou micro-ondes." },
    { title: "Mélange", text: "Fouetter les œufs et le sucre dans un cul-de-poule jusqu'à ce que le mélange blanchisse légèrement. Ajouter le mélange chocolat/beurre tiède." },
    { title: "Cuisson", text: "Incorporer la farine tamisée. Verser dans un moule beurré et fariné. Cuire à 180°C environ 20-25 min. Le cœur doit rester tendre." }
  ];
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>Surveillez bien la cuisson : le centre du gâteau doit être encore un peu tremblotant à la sortie du four.</li>
                           <li>Utilisez un bon chocolat noir à 60% ou 70% pour un goût intense.</li>
                           <li>Ce gâteau se conserve très bien quelques jours enveloppé dans un film alimentaire.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "C'est la recette 'joker' par excellence. Rapide, facile, et qui plaît à tout le monde. Servez-le avec une crème anglaise ou une boule de glace vanille pour un dessert complet."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-2 text-gray-400">
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Moule à manqué 22cm</li>
