...
const CremeuxEstragon = () => {
  ...
  const steps = [
    { title: "Infusion", text: "Chauffer le lait et la crème. Ajouter l'estragon. Laisser infuser 20 min." },
    { title: "Filtration", text: "Chinoiser. Réajuster le poids." },
    { title: "Cuisson", text: "Cuire à l'anglaise (83°C) avec les jaunes et le sucre." },
    { title: "Collage", text: "Incorporer la gélatine hydratée et verser sur le chocolat blanc." },
    { title: "Emulsion", text: "Mixer pour obtenir une crème lisse." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Combinaison</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Essayez l'estragon avec la pêche blanche ou la cerise, c'est une association classique de la pâtisserie moderne.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Dosage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">L'estragon est puissant. Goûtez l'infusion avant de cuire l'anglaise et ajustez si nécessaire.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
