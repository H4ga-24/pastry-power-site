...
const BiscuitMirliton = () => {
  const baseServings = 1;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit Mirliton",
    prepTime: "15 MIN",
    cookTime: "25 MIN",
    difficulty: "FACILE",
    description: "Un appareil riche aux amandes, souvent utilisé pour garnir des tartes aux fruits.",
    image: "https://www.guydemarle.com/rails/active_storage/representations/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBMWNQQXc9PSIsImV4cCI6bnVsbCwicHVyIjoiYmxvYl9pZCJ9fQ==----929a1958a8630156464b089800ca739f1b4570de/mirlitons-framboises-46020.webp",
  };
  ...
  const ingredients = [
    ...
    { name: 'Crème fraîche épaisse', amount: 125, unit: 'g' },
    { name: 'Extrait de vanille', amount: 1, unit: 'c.à.c' }
  ];

  const steps = [
    { title: "PRÉPARATION", text: "Blanchir les oeufs avec le sucre." },
    { title: "POUDRES", text: "Ajouter la poudre d'amande et la vanille." },
    { title: "CRÈME", text: "Incorporer la crème fraîche pour obtenir un mélange homogène." },
    { title: "UTILISATION", text: "Verser sur un fond de tarte précuit ou garni de fruits." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 20 à 25 minutes." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 tarte</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Parfait pour accompagner des poires ou des abricots.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ne pas trop cuire pour garder le moelleux.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitMirliton;