...
const CremeBrulee = () => {
  const baseServings = 4; // ramequins
  ...
  const ingredients = [
    { name: 'Crème liquide entière', amount: 400, unit: 'g' },
  ...
  const steps = [
    ...
    {
      title: "CUISSON.",
      text: "Verser dans des ramequins. Cuire au bain-marie au four à 100°C pendant environ 1h. La crème doit être prise mais encore tremblotante."
    },
    {
      title: "FINITION.",
      text: "Laisser refroidir complètement au frais. Au moment de servir, saupoudrer de cassonade et brûler au chalumeau."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Une cuisson lente et douce est la clé pour obtenir une crème soyeuse et non granuleuse.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
