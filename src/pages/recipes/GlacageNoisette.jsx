                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ce glaçage se conserve très bien dans un endroit sec (pas besoin de frigo s'il est utilisé rapidement) ou au frigo plusieurs semaines.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
