...
const BiscuitPainEpice = () => {
  ...
  const recipeData = {
    ...
    cookTime: "50 MIN",
    difficulty: "FACILE",
    description: "Le véritable pain d'épice, riche en miel et aux parfums envoûtants de cannelle et d'anis.",
    image: "https://evacuisine.fr/wp-content/uploads/2013/11/91167916.jpg",
  };

  const ingredients = [
    { name: 'Miel', amount: 250, unit: 'g' },
    { name: 'Farine de seigle', amount: 250, unit: 'g' },
    { name: 'Lait', amount: 100, unit: 'ml' },
    { name: 'Sucre cassonade', amount: 50, unit: 'g' },
    { name: 'Épices à pain d\'épice', amount: 10, unit: 'g' },
    { name: 'Bicarbonate de soude', amount: 5, unit: 'g' }
  ];

  const steps = [
    { title: "CHAUFFE", text: "Faire chauffer le miel avec le lait." },
    { title: "MÉLANGE SEC", text: "Mélanger la farine, le sucre, les épices et le bicarbonate." },
    { title: "APPAREIL", text: "Verser le mélange liquide chaud sur les poudres et remuer énergiquement." },
    { title: "CUISSON", text: "Verser dans un moule à cake et cuire à 160°C pendant 50 minutes à 1h." },
    { title: "FINITION", text: "Laisser refroidir avant de démouler." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 cake</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Meilleur après 24 à 48h de repos bien emballé.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Garniture</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ajouter des écorces d'orange confites pour plus de gourmandise.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitPainEpice;