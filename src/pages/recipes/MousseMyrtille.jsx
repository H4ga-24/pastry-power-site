...
const MousseMyrtille = () => {
  ...
  const steps = [
    ...
    { title: "MÉLANGE", text: "Incorporer la crème à la purée gélifiée." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La myrtille est très douce, il faut absolument du citron pour relever son goût.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Sauvage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Les myrtilles sauvages sont bien plus parfumées et colorantes que les myrtilles de culture.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
