...
const SpongeCake = () => {
  ...
  const steps = [
    { title: "CRÉMAGE", text: "Battre le beurre et le sucre jusqu'à obtention d'une crème pâle." },
    { title: "OEUFS", text: "Ajouter les oeufs un à un en fouettant bien entre chaque." },
    { title: "ARÔME", text: "Ajouter la vanille." },
    { title: "POUDRES", text: "Incorporer la farine et la levure tamisées." },
    { title: "CUISSON", text: "Verser dans deux moules et cuire à 180°C pendant 25-30 minutes." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Idéal pour être fourré de crème au beurre et recouvert de pâte à sucre.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Tous les ingrédients doivent être à température ambiante.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
