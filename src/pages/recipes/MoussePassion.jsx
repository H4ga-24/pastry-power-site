...
const MoussePassion = () => {
  ...
  const steps = [
    ...
    { title: "COLLAGE", text: "Incorporer la gélatine essorée. Mélanger avec le reste de purée." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Les grains de passion peuvent être désagréables. Utilisez une purée sans grains ou filtrez-la.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le top du top avec le chocolat au lait ou la noisette.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
