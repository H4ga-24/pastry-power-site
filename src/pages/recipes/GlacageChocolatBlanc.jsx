                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Opacité</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le chocolat blanc étant naturellement jaunâtre et translucide, ajoutez du colorant blanc (dioxyde de titane) pour avoir une base parfaitement blanche et opaque avant d'ajouter d'autres couleurs.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
