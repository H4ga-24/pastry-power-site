...
const PetitFourPateAmande = () => {
  ...
  const ingredients = [
    ...
    { name: 'Sucre glace (facultatif)', amount: 20, unit: 'g' },
    { name: 'Fruits confits (décor)', amount: 50, unit: 'g' }
  ];

  const steps = [
    { title: "ASSOUPLISSEMENT", text: "Ramollir légèrement la pâte d'amande au batteur avec la feuille ou à la main." },
    { title: "INCORPORATION", text: "Ajouter les blancs d'œufs très progressivement (presque goutte à goutte) tout en battant pour détendre la pâte sans la rendre liquide." },
    { title: "CONSISTANCE", text: "La pâte doit être souple mais tenir sa forme (bec d'oiseau ferme)." },
    { title: "DRESSAGE", text: "Pocher avec une douille cannelée sur une plaque doublée." },
    { title: "DÉCOR", text: "Ajouter un morceau de fruit confit sur le dessus." },
    { title: "SÉCHAGE", text: "Laisser croûter 1h à température ambiante." },
    { title: "CUISSON", text: "Cuire à four très chaud (220°C) pendant 5 à 8 minutes. Ils doivent juste dorer sur les arêtes." }
  ];
