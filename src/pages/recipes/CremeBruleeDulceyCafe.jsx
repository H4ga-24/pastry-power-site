...
const CremeBruleeDulceyCafe = () => {
  const baseServings = 6; // ramequins
  ...
  const recipeData = {
    ...
    cookTime: "45 MIN",
    difficulty: "MOYEN",
    description: "Une variante gourmande de la crème brûlée mariant la douceur biscuitée du chocolat blond Dulcey à l'amertume subtile du café.",
  ...
  const steps = [
    ...
    {
      title: "MÉLANGE.",
      text: "Fouetter les jaunes d'oeufs avec le sucre (sans blanchir). Réchauffer le mélange lait/crème si nécessaire et le verser sur le chocolat Dulcey pour le faire fondre (réaliser une ganache)."
    },
    {
      title: "APPAREIL.",
    ...
    {
      title: "REPOS.",
      text: "Laisser refroidir puis placer au réfrigérateur au moins 4h pour que la crème fige parfaitement."
    },
    {
      title: "FINITION.",
      text: "Au moment de servir, saupoudrer de cassonade et caraméliser au chalumeau."
    }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Ramequins</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Écume</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si de l'écume se forme en surface après avoir versé dans les ramequins, passez rapidement un petit coup de chalumeau pour la faire disparaître avant cuisson.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Cuisson douce</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ne dépassez pas 100°C. Si la crème bout, elle va grainer. Une cuisson douce et longue garantit le fondant.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
