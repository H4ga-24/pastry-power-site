...
const PainDeGene = () => {
  ...
  const ingredients = [
    ...
    { name: 'Masse obtenue', amount: 277, unit: 'g' }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Origine</h4>
                      <p className="text-gray-400 font-light leading-relaxed">
                        Malgré son nom, le pain de Gênes n'est pas originaire de Gênes (Italie). Il aurait été créé à Paris au début du XIXe siècle, en hommage à la bravoure des soldats blessés à la bataille de Gênes (1800).
                      </p>
                    </TabsContent>
                    
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Déclinaisons</h4>
                      <p className="text-gray-400 font-light leading-relaxed">
                        Il est très utilisé en pâtisserie pour ses qualités de conservation, sa tenue à la découpe, et sa polyvalence : il peut être utilisé en biscuit de base, en feuille pour entremets, ou encore moulé pour une dégustation individuelle.
                      </p>
                    </TabsContent>
                  </div>
                </Tabs>
