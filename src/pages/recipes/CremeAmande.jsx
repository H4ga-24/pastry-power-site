...
const CremeAmande = () => {
  const baseServings = 400; // grammes
  ...
  const recipeData = {
    ...
    cookTime: "20-30 MIN",
    difficulty: "FACILE",
    description: "Une base fondamentale de la pâtisserie, composée de tant pour tant (poids égal) de beurre, sucre, poudre d'amande et œufs.",
  ...
  const ingredients = [
    ...
    { name: 'Fécule de maïs (facultatif)', amount: 10, unit: 'g' },
  ];

  const steps = [
    {
      title: "CRÉMAGE.",
      text: "Dans un bol, mélanger le beurre pommade avec le sucre jusqu'à obtenir une texture crémeuse."
    },
    {
      title: "POUDRES.",
      text: "Ajouter la poudre d'amande (et la fécule) et mélanger."
    },
    {
      title: "OEUFS.",
      text: "Incorporer les œufs un par un en mélangeant bien entre chaque ajout pour éviter que la masse ne tranche."
    },
    {
      title: "UTILISATION.",
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Aération</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ne foisonnez pas trop le mélange beurre/sucre pour éviter que la crème ne gonfle trop à la cuisson et ne retombe ensuite.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
