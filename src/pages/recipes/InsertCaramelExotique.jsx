...
const InsertCaramelExotique = () => {
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Chauffer la purée de fruits exotiques sans la faire bouillir. Hydrater la gélatine." },
    { title: "CARAMEL", text: "Cuire le sucre et le glucose au caramel ambré." },
    { title: "DÉCUISSON", text: "Verser la purée chaude sur le caramel petit à petit en remuant vivement." },
    { title: "CUISSON", text: "Cuire le tout à 103°C pour assurer une bonne conservation et texture." },
    { title: "FINITION", text: "Refroidir à 40°C, ajouter le beurre et la gélatine. Mixer pour lisser." },
    { title: "STOCKAGE", text: "Couler en moule insert et congeler." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le fruit de la passion apporte une acidité qui casse le sucre du caramel. N'hésitez pas à ajuster selon vos goûts.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez varier les plaisirs avec de la purée d'ananas ou de l'orange sanguine.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
