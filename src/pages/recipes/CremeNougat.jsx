...
const CremeNougat = () => {
  ...
  const steps = [
    {
      title: "FONTE.",
      text: "Dans une casserole, faire chauffer le lait avec la pâte de nougat coupée en petits morceaux pour la faire fondre."
    },
    {
      title: "BLANCHIR.",
    ...
    {
      title: "MÉLANGE.",
      text: "Verser la moitié du lait au nougat chaud sur les jaunes. Mélanger et remettre le tout dans la casserole."
    },
    {
      title: "CUISSON.",
      text: "Porter à ébullition en fouettant constamment et cuire 2 minutes à ébullition pour épaissir."
    },
    {
      title: "FINITION.",
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Pâte de nougat</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si vous n'avez pas de pâte de nougat, vous pouvez utiliser du vrai nougat dur mixé finement, mais la texture sera plus granuleuse.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
