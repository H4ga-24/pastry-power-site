...
const CremeuxFruitGelifier = () => {
  ...
  const recipeData = {
    title: "Crémeux au Fruit Gélifier",
    category: "PÂTISSERIE • CRÉMEUX",
    prepTime: "25 MIN",
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Une variante de crémeux aux fruits mettant l'accent sur la tenue et la texture, idéale pour les montages complexes et les pochages nets.",
  ...
  const ingredients = [
    ...
    { name: 'Gélatine', amount: 5, unit: 'g' },
    { name: 'Beurre doux', amount: 90, unit: 'g' }
  ];

  const steps = [
    { title: "Préparation", text: "Hydrater la gélatine (quantité légèrement supérieure pour une meilleure tenue)." },
    { title: "Cuisson", text: "Chauffer la purée. Mélanger œufs, jaunes et sucre. Cuire le tout à la nappe (83°C) comme une anglaise aux fruits." },
    { title: "Collage", text: "Ajouter la gélatine essorée hors du feu. Chinoiser." },
    { title: "Emulsion", text: "Laisser refroidir à 35°C, incorporer le beurre et mixer longuement." },
    { title: "Cristallisation", text: "Laisser prendre au froid positif pendant au moins 6h." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Gélification</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Cette recette contient légèrement plus de gélatine que les crémeux standards pour assurer une tenue parfaite lors de la découpe d'entremets.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Fruits</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Fonctionne parfaitement avec les fruits rouges, l'abricot ou la mangue.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
