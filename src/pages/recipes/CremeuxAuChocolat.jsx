...
const CremeuxAuChocolat = () => {
  ...
  const steps = [
    { title: "Préparation", text: "Hacher le chocolat ou utiliser des pistoles. Placer dans un cul-de-poule." },
    { title: "Cuisson", text: "Réaliser une crème anglaise : chauffer lait et crème, verser sur les jaunes mélangés au sucre, et cuire à 83°C en remuant constamment." },
    { title: "Mélange", text: "Verser la crème anglaise chaude sur le chocolat. Attendre 1 minute que le chocolat fonde." },
    { title: "Emulsion", text: "Mélanger à la maryse en créant un noyau élastique et brillant. Finaliser au mixeur plongeant pour lisser parfaitement." },
    { title: "Repos", text: "Laisser cristalliser au réfrigérateur plusieurs heures avant utilisation." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Gélatine</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Avec du chocolat noir à 70%, il n'est généralement pas nécessaire d'ajouter de gélatine, le beurre de cacao suffit à donner la texture. Si vous utilisez du chocolat au lait, ajoutez 2g de gélatine.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Brillance</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Une émulsion bien réalisée (noyau élastique et brillant) est la clé d'un crémeux réussi et stable.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
