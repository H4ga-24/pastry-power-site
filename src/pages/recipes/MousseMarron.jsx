...
const MousseMarron = () => {
  ...
  const steps = [
    ...
    { title: "MÉLANGE", text: "Détendre la pâte de marron avec la crème de marron et le rhum. Chauffer légèrement une petite partie pour fondre la gélatine." },
    { title: "COLLAGE", text: "Incorporer la gélatine fondue au mélange de marrons." },
    { title: "MONTAGE", text: "Monter la crème en chantilly." },
    { title: "FINITION", text: "Mélanger délicatement les deux masses." },
    { title: "DRESSAGE", text: "Pocher ou couler." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le mélange pâte/crème de marron permet d'avoir le goût intense ET une texture pas trop pâteuse.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Brisures</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des brisures de marrons glacés à la fin pour le luxe.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
