                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La température du mélange chocolat/pâte à bombe doit être autour de 40°C avant d'incorporer la crème.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">C'est la mousse idéale pour les entremets qui doivent supporter la congélation.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
