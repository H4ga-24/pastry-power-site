...
const MousseChocolatPateABombe = () => {
  const recipeData = {
    ...
    baseServings: 1, // Pour 1 entremets de 20cm
  };
  ...
  const ingredients = [
    ...
    { name: 'Sirop (sucre + eau)', amount: 100, unit: 'g' }
  ];

  const steps = [
    { title: "CHOCOLAT", text: "Faire fondre le chocolat au bain-marie à 45°C-50°C." },
    { title: "PÂTE À BOMBE", text: "Cuire le sucre et un peu d'eau à 118°C. Verser sur les jaunes d'œufs tout en fouettant jusqu'à refroidissement complet (ruban)." },
    { title: "CRÈME FOUETTÉE", text: "Monter la crème fleurette en chantilly mousseuse (pas trop ferme)." },
    { title: "MÉLANGE", text: "Incorporer une partie de la crème fouettée dans le chocolat fondu (45°C), puis ajouter la pâte à bombe délicatement." },
    { title: "FINITION", text: "Terminer en incorporant le reste de la crème fouettée à la maryse." }
  ];
              ...
              <div className="bg-[#1a1a1a] p-8 rounded-sm border border-white/5 sticky top-24">
                ...
                <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-6">
                  <div className="flex items-center gap-2 text-[#D4AF37]">
                    ...
                    <span className="font-serif text-lg">Cercle (20cm)</span>
                  </div>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>La crème fleurette doit être montée mousseuse (texture bec d'oiseau), pas ferme, pour s'incorporer facilement sans grainer.</li>
                           <li>Cette mousse a une texture dense et fondante, idéale pour les entremets qui doivent être congelés.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "La clé de la réussite est la température. Le mélange chocolat/pâte à bombe doit être autour de 40-45°C au moment d'incorporer la crème montée. Trop chaud, la crème retombe. Trop froid, le chocolat fige et fait des grains."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-2 text-gray-400">
                          ...
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Robot pâtissier (fouet)</li>
