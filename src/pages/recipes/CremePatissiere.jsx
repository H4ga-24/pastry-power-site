...
const CremePatissiere = () => {
  ...
  const steps = [
    {
      title: "INFUSION.",
      text: "Faire chauffer le lait avec la gousse de vanille grattée. Laisser infuser 10 minutes."
    },
    {
      title: "BLANCHIR.",
      text: "Fouetter les jaunes avec le sucre jusqu'à blanchiment. Ajouter la poudre à crème et fouetter de nouveau."
    },
    {
      title: "MÉLANGE.",
      text: "Verser la moitié du lait chaud sur le mélange oeufs/poudre. Mélanger et reverser le tout dans la casserole."
    },
    {
      title: "CUISSON.",
      text: "Porter à ébullition sans cesser de fouetter énergiquement. Cuire 2 minutes après la reprise de l'ébullition pour bien pasteuriser et cuire l'amidon."
    },
    {
      title: "FINITION.",
      text: "Hors du feu, ajouter le beurre froid et mélanger. Débarrasser sur une plaque, filmer au contact et refroidir rapidement au frais."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Hygiène</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La crème pâtissière est un milieu fragile pour les bactéries. Il est impératif de la refroidir rapidement et de ne pas la conserver plus de 24h à 48h.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
