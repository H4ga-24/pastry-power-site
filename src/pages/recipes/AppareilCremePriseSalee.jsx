...
const AppareilCremePriseSalee = () => {
  const recipeData = {
    category: "CUISINE • SAUCES", // 👈 Déplacé en Cuisine car c'est une base salée
  ...
  const structuredData = {
    ...
    "recipeCategory": "Base culinaire",
    "keywords": "appareil à quiche, crème prise salée, base cuisine, flan salé",
                ...
                <div className="bg-[#1a1a1a] border-x border-b border-white/5 p-8 mt-0 min-h-[150px]">
                  <TabsContent value="conseils" className="mt-0 focus-visible:outline-none">
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        <h4 className="text-lg font-serif text-white">Variantes de texture</h4>
                  ...
                  <TabsContent value="chef" className="mt-0 focus-visible:outline-none">
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        <h4 className="text-lg font-serif text-white">Le secret de l'assaisonnement</h4>
                        <p className="text-gray-400 leading-relaxed italic">
                          "Ne lésinez pas sur la noix de muscade, c'est elle qui donne l'identité à cet appareil. Si vous utilisez des garnitures déjà salées (lardons, fromage), réduisez légèrement la dose de sel."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
