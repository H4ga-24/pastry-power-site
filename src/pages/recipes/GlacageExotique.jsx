...
const GlacageExotique = () => {
  ...
  const steps = [
    {
      title: "GÉLATINE.",
      text: "Hydrater la gélatine en poudre dans l'eau d'hydratation froide. Laisser gonfler au réfrigérateur pendant 20 minutes."
    },
    {
      title: "SIROP.",
      text: "Dans une casserole, verser l'eau, le sucre et le glucose. Porter à ébullition jusqu'à atteindre 103°C."
    },
    {
      title: "VERSER.",
      text: "Dans un pichet haut, mettre le chocolat blanc, le lait concentré, la purée de fruits et la masse gélatine. Verser le sirop bouillant dessus."
    },
    {
      title: "MIXER.",
      text: "Laisser fondre quelques instants puis mixer au mixeur plongeant en faisant attention de ne pas incorporer de bulles d'air."
    },
    {
      title: "REPOS.",
      text: "Filmer au contact et laisser reposer au frais 12h. Réchauffer et utiliser à 30-35°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Colorant</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Selon la couleur de votre purée, vous pouvez ajouter une pointe de colorant jaune ou orange hydrosoluble pour raviver la teinte, car le chocolat blanc a tendance à pastelliser la couleur.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
