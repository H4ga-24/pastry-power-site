...
const BiscuitSansFarine = () => {
  const baseServings = 1;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit sans farine",
    prepTime: "25 MIN",
    cookTime: "30 MIN",
    difficulty: "MOYEN",
    description: "Un biscuit ultra-fondant au chocolat, idéal pour les intolérants au gluten.",
    image: "https://www.lesfoodies.com/_recipeimage/54549/gateau-au-chocolat-sans-farine-pour-base-gateaux-couches.jpg",
  };
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Faire fondre le chocolat et le beurre ensemble." },
    { title: "MÉLANGE", text: "Monter les blancs en neige avec une partie du sucre." },
    { title: "APPAREIL", text: "Blanchir les jaunes avec le reste du sucre, ajouter le mélange chocolat/beurre." },
    { title: "INCORPORATION", text: "Incorporer délicatement les blancs montés et la poudre d'amande." },
    { title: "CUISSON", text: "Cuire à 170°C pendant 30 minutes environ." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 biscuit</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utiliser un chocolat de couverture pour un résultat optimal.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Variation</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Peut être parfumé avec des zestes d'orange.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitSansFarine;