...
const DacquoiseAmande = () => {
  ...
  const recipeData = {
    ...
    cookTime: "30 MIN",
    difficulty: "MOYEN",
    description: "La dacquoise est un gâteau originaire du Sud-Ouest de la France, constitué de deux ou trois disques de pâte meringuée aux amandes, séparés par des couches de crème au beurre diversement parfumée, et poudré de sucre glace.",
  ...
  const ingredients = [
    ...
    { name: 'Fonds réalisés (Nombre)', amount: 3, unit: '' }
  ];

  const steps = [
    {
      title: "MERINGUE.",
      text: "Monter les blancs d'œufs et serrer avec le sucre semoule."
    },
    {
      title: "TAMISAGE.",
      text: "Tamiser les poudres."
    },
    {
      title: "MÉLANGE.",
      text: "Incorporer délicatement à la Maryse, le mélange tamisé aux blancs d'œufs montés."
    },
    {
      title: "DRESSAGE.",
      text: "Dresser la forme désirée (ex: 3 fonds de Ø 18/20 cm douille unie n°10)."
    },
    {
      title: "CUISSON.",
      text: "Cuire dans un four à 180°C sans buée pendant 15 minutes. Le biscuit doit être blanc/ blond sur toute sa surface. Détourner et débarrasser immédiatement sur grille."
    }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Fonds de 20cm</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    ...
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Associations</h4>
                      <p className="text-gray-400 font-light leading-relaxed">
