...
const CakeSaumonOseille = () => {
  const ingredients = [
    ...
    { name: "Saumon frais", amount: "200g" },
    { name: "Oseille", amount: "200g" },
    { name: "Beurre 1/2 sel", amount: "30g" },
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake Saumon Oseille - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake Saumon Oseille" src="https://lespapillesdekaren.com/wp-content/uploads/2025/04/wp_57dab1_cake-au-saumon-et-a-l-oseille.JPG" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake Saumon & Oseille</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Coupez le saumon frais en dés. Ciselez l'oseille et faites-la fondre rapidement dans le beurre à la poêle.</p>
              ...
              <p><span className="text-[#D4AF37] font-bold">3.</span> Ajoutez les œufs, l'huile et le lait. Mélangez pour obtenir une pâte homogène.</p>
              <p><span className="text-[#D4AF37] font-bold">4.</span> Incorporez le gruyère râpé, les dés de saumon et l'oseille. Salez et poivrez.</p>
              <p><span className="text-[#D4AF37] font-bold">5.</span> Versez dans un moule à cake et enfournez pour environ 45 minutes.</p>
            </div>
          </div>
        </div>
      </div>
