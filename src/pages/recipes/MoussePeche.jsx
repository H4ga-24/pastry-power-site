...
const MoussePeche = () => {
  ...
  const steps = [
    ...
    { title: "CHAUFFE", text: "Chauffer une partie de la purée avec le sucre." },
    { title: "COLLAGE", text: "Incorporer la gélatine. Mélanger avec le reste de purée et le citron." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Oxydation</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La pêche s'oxyde vite, le citron est obligatoire pour garder une belle couleur.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Variété</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La pêche blanche est plus parfumée, la pêche jaune apporte plus de tenue et de couleur.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
