...
const BiscuitNoisette = () => {
  ...
  const recipeData = {
    ...
    cookTime: "30 MIN",
    difficulty: "FACILE",
    description: "Le goût intense de la noisette dans un biscuit moelleux, parfait pour le thé ou comme base d'entremets.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/07/biscuit-noisettes-1300x859.png",
  };

  const ingredients = [
    { name: 'Sucre noisette', amount: 300, unit: 'g' },
    { name: 'Oeufs', amount: 250, unit: 'g' },
    { name: 'Sucre Cassonade', amount: 50, unit: 'g' },
    { name: 'Farine', amount: 50, unit: 'g' },
    { name: 'Farine de maïs', amount: 50, unit: 'g' },
    { name: 'Levure chimique', amount: 50, unit: 'g' },
    { name: 'Noisette moulue', amount: 50, unit: 'g' },
  ...
  const steps = [
    {
      title: "BLANCHIR.",
      text: "Dans la cuve du batteur, blanchir les sucres (noisette et cassonade) avec les œufs entiers jusqu'à ce que le mélange double de volume."
    },
    {
      title: "POUDRES.",
      text: "Tamiser ensemble la farine, la farine de maïs et la levure chimique. Les ajouter délicatement au mélange."
    },
    {
      title: "NOISETTES.",
      text: "Incorporer la noisette moulue et mélanger doucement pour ne pas faire retomber l'appareil."
    },
    {
      title: "BEURRE.",
      text: "Ajouter enfin le beurre fondu refroidi."
    },
    {
      title: "MOULAGE ET CUISSON.",
      text: "Verser dans un moule beurré et cuire 30 min à 180°C (vérifier la cuisson à la pointe du couteau)."
    },
    {
      title: "FINITION.",
      text: "Démouler, laisser refroidir sur grille, découper selon la forme souhaitée et servir."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Torréfaction</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour un goût plus prononcé, torréfiez légèrement la poudre de noisette avant de l'incorporer.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Remplacez une partie du beurre par du praliné pour encore plus de gourmandise.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'utilisation de la farine de maïs apporte une couleur jaune dorée appétissante et une texture légèrement sablée.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitNoisette;