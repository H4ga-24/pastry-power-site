...
const CremeFrangipane = () => {
  const baseServings = 600; // grammes
  ...
  const ingredients = [
    ...
    { name: 'Rhum (facultatif)', amount: 10, unit: 'g' },
  ];

  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Réaliser d'abord une crème pâtissière et la laisser refroidir."
    },
    {
      title: "CRÈME D'AMANDE.",
      text: "Réaliser une crème d'amande (beurre, sucre, poudre d'amande, oeufs)."
    },
    {
      title: "MÉLANGE.",
      text: "Lisser la crème pâtissière froide au fouet. L'incorporer délicatement à la crème d'amande."
    },
    {
      title: "AROMATISATION.",
      text: "Ajouter le rhum ou l'arôme de votre choix et mélanger pour homogénéiser."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Ratio</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le ratio classique est de 2/3 de crème d'amande pour 1/3 de crème pâtissière, ce qui apporte moelleux et légèreté.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
