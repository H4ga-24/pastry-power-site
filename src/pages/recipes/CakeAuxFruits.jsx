...
const CakeAuxFruits = () => {
  const recipeData = {
    ...
    cookTime: "1H 10",
    difficulty: "MOYEN",
    description: "Le cake anglais traditionnel riche en fruits confits et raisins.",
  ...
  const ingredients = [
    { name: "Beurre pommade", amount: "250g" },
    { name: "Sucre cassonade", amount: "200g" },
    { name: "Oeufs entiers", amount: "250g (5)" },
    { name: "Farine T55", amount: "320g" },
    { name: "Levure chimique", amount: "8g" },
    { name: "Fruits confits (cubes)", amount: "200g" },
    { name: "Raisins secs", amount: "100g" },
    { name: "Rhum ambré", amount: "50g" },
    { name: "Cerises confites", amount: "50g" }
  ];

  const steps = [
    { title: "Macération", text: "La veille, faire macérer les raisins secs et les fruits confits dans le rhum." },
    { title: "Crémage", text: "Mélanger le beurre pommade et la cassonade jusqu'à obtenir un mélange homogène." },
    { title: "Émulsion", text: "Ajouter les œufs un à un en fouettant vivement." },
    { title: "Mélange", text: "Incorporer la farine tamisée avec la levure. Mélanger sans trop travailler." },
    { title: "Garniture", text: "Égoutter les fruits (si nécessaire) et les fariner légèrement. Les incorporer délicatement à la pâte." },
    { title: "Cuisson", text: "Verser dans un moule beurré. Cuire à 160°C pendant 1h à 1h15. Vérifier la cuisson avec la pointe d'un couteau." }
  ];
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>Pour éviter que les fruits ne tombent au fond du moule, enrobez-les d'un peu de farine avant de les incorporer à l'appareil.</li>
                           <li>C'est un gâteau qui se bonifie avec le temps. Emballé hermétiquement, il peut se conserver plus d'une semaine et gagnera en saveurs.</li>
                           <li>Nappez le cake froid de nappage abricot et décorez avec quelques beaux morceaux de fruits confits et d'amandes effilées grillées.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "Le cake aux fruits confits demande du temps et de bons ingrédients. Choisissez des fruits confits de qualité, moelleux et parfumés. C'est toute la différence entre un cake ordinaire et un cake d'exception."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
