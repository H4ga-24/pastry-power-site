...
const CremeBavaroiseChocolatBlanc = () => {
  ...
  const recipeData = {
    ...
    title: "Crème bavaroise au chocolat blanc",
  ...
  const steps = [
    {
      title: "ANGLAISE.",
      text: "Réaliser une crème anglaise avec le lait, les jaunes et le sucre (quantité de sucre réduite car le chocolat est sucré)."
    },
    {
      title: "EMULSION.",
      text: "Verser la crème anglaise chaude sur le chocolat blanc haché. Laisser fondre quelques instants puis mélanger pour émulsionner."
    },
    {
      title: "GÉLATINE.",
      text: "Ajouter la gélatine réhydratée et essorée dans le mélange chaud. Bien dissoudre."
    },
    {
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez un chocolat blanc de couverture de qualité (type Ivoire de Valrhona ou Zephyr de Cacao Barry) pour éviter un goût trop sucré et pâteux.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
