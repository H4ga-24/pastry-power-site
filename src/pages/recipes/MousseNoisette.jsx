...
const MousseNoisette = () => {
  ...
  const ingredients = [
    ...
    { name: 'Mascarpone (facultatif)', amount: 50, unit: 'g' }
  ];

  const steps = [
    { title: "GÉLATINE", text: "Réhydrater la gélatine dans l'eau froide." },
    { title: "CHAUFFE", text: "Chauffer les 50ml de crème liquide. Y faire fondre la gélatine essorée." },
    { title: "ÉMULSION", text: "Verser la crème chaude sur le praliné en 3 fois, en frictionnant pour créer une émulsion élastique et brillante." },
    { title: "MONTAGE", text: "Monter la crème liquide froide (et le mascarpone si utilisé) en chantilly souple." },
    { title: "MÉLANGE", text: "Quand le mélange praliné est tiède (35°C), incorporer délicatement la chantilly." },
    { title: "UTILISATION", text: "Utiliser de suite pour garnir ou mettre en verrines." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez un praliné riche en noisettes (60%) pour un goût plus puissant.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Croustillant</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des noisettes torréfiées concassées sur le dessus.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
