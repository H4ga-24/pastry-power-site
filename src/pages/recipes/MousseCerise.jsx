...
const MousseCerise = () => {
  ...
  const steps = [
    ...
    { title: "CHAUFFE", text: "Chauffer un tiers de la purée de cerise avec le sucre. Ajouter la gélatine essorée hors du feu." },
    { title: "MÉLANGE", text: "Mélanger avec le reste de la purée froide et le Kirsch." },
    { title: "REFROIDISSEMENT", text: "Laisser épaissir légèrement à température ambiante." },
    { title: "CHANTILLY", text: "Monter la crème en chantilly pas trop ferme." },
    { title: "INCORPORATION", text: "Incorporer délicatement la chantilly à la purée de cerise." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Associez cette mousse avec une mousse chocolat noir ou pistache pour un duo classique et efficace.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Griottes</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Les griottes apportent plus d'acidité que les cerises classiques, ajustez le sucre en conséquence.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
