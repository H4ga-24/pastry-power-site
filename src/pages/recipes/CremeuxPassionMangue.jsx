...
const CremeuxPassionMangue = () => {
  ...
  const steps = [
    ...
    { title: "Cuisson", text: "Mélanger les purées de fruits dans une casserole et chauffer. Fouetter les œufs, jaunes et sucre. Verser les fruits chauds sur le mélange, reverser dans la casserole." },
    { title: "Épaississement", text: "Cuire à la nappe (83°C-84°C) en remuant constamment à la spatule." },
    { title: "Collage", text: "Ajouter la gélatine essorée hors du feu. Laisser refroidir jusqu'à 35°C/40°C." },
    { title: "Emulsion", text: "Incorporer le beurre froid coupé en dés et mixer longuement pour obtenir une crème lisse et brillante." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Équilibre</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez varier le ratio passion/mangue selon vos préférences (plus acide ou plus doux), en gardant le même poids total de fruits (250g).</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Grains</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si vous utilisez des fruits frais, veillez à bien chinoiser la purée de passion pour retirer les grains noirs désagréables en bouche.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
