...
const MousseKiwi = () => {
  ...
  const steps = [
    ...
    { title: "CUISSON", text: "Si vous utilisez des kiwis frais, mixez-les et portez à ébullition 2 minutes pour détruire l'enzyme actinidine. Sinon la mousse ne prendra jamais." },
    { title: "COLLAGE", text: "Ajouter le sucre et la gélatine essorée dans la purée chaude." },
    { title: "REFROIDISSEMENT", text: "Laisser refroidir jusqu'à température ambiante." },
    { title: "MONTAGE", text: "Monter la crème en chantilly." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème à la purée." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Attention Danger</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le kiwi cru contient de l'actinidine qui "mange" la gélatine. Il faut impérativement cuire le fruit avant.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Une pointe de colorant vert pomme peut raviver la couleur qui ternit à la cuisson.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
