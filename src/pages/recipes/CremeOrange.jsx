...
const CremeOrange = () => {
  ...
  const recipeData = {
    ...
    title: "La crème à l'orange",
    prepTime: "25 MIN",
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Aussi appelée 'Orange Curd', cette crème onctueuse est riche en saveurs d'agrumes. Idéale pour les tartes meringuées ou en insert dans les entremets.",
    image: "https://www.mycake.fr/wp-content/uploads/2019/02/rs_CurdOrange_4x3.jpg",
  };

  const ingredients = [
    { name: 'Jus d\'orange fraîchement pressé', amount: 200, unit: 'g' },
    ...
    { name: 'Feuille de gélatine', amount: 2, unit: 'g' }
  ];

  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Réhydrater la gélatine dans un grand bol d'eau froide. Zester l'orange et presser le jus."
    },
    {
      title: "CUISSON À LA NAPPE.",
      text: "Dans une casserole, mélanger le jus d'orange, les zestes, le sucre et les oeufs. Chauffer à feu doux en remuant constamment au fouet jusqu'à épaississement (83°C-84°C), comme une crème anglaise."
    },
    {
      title: "GÉLATINE.",
      text: "Retirer du feu immédiatement pour ne pas faire coaguler les oeufs. Ajouter la gélatine essorée et mélanger."
    },
    {
      title: "REFROIDISSEMENT.",
      text: "Filtrer la préparation au chinois (facultatif si vous aimez les zestes) dans un récipient haut. Laisser redescendre la température à 35°C-40°C."
    },
    {
      title: "EMULSION.",
      text: "Incorporer le beurre froid coupé en dés petit à petit tout en mixant au mixeur plongeant. C'est cette étape qui donne l'onctuosité."
    },
    {
      title: "STOCKAGE.",
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Agrumes</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Cette recette fonctionne avec tous les agrumes : citron, pamplemousse, yuzu, mandarine... Ajustez simplement le sucre selon l'acidité du fruit.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si vous n'avez pas de thermomètre, arrêtez la cuisson dès les premiers signes d'ébullition (petits bouillons) et retirez vite du feu pour ne pas avoir d'omelette sucrée.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
