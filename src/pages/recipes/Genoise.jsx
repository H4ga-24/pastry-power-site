...
const Genoise = () => {
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Préparer tous les ingrédients et préchauffer le four à 180°C." },
    { title: "MÉLANGE", text: "Fouetter les oeufs et le sucre au bain-marie jusqu'à atteindre 50°C." },
    { title: "FOISONNEMENT", text: "Battre le mélange au robot jusqu'à refroidissement complet et obtention d'un ruban." },
    { title: "INCORPORATION", text: "Incorporer délicatement la farine tamisée à la maryse." },
    { title: "CUISSON", text: "Verser dans le moule et cuire 20 à 25 minutes." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 génoise</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ne pas trop travailler l'appareil après l'ajout de la farine pour éviter qu'il ne retombe.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Se conserve bien filmée au réfrigérateur ou peut être congelée.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
