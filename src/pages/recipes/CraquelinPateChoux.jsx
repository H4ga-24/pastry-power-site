...
const CraquelinPateChoux = () => {
  ...
  const recipeData = {
    ...
    cookTime: "N/A",
    difficulty: "FACILE",
    description: "Le craquelin permet à la pâte à choux de se développer plus régulièrement. Il donne aussi un goût sympathique et un effet croquant.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/12/IMG_20221212_081945-975x1300.jpg",
  };

  const ingredients = [
    { name: 'Beurre', amount: 45, unit: 'g' },
    { name: 'Sucre cassonade', amount: 45, unit: 'g' },
    { name: 'Farine', amount: 110, unit: 'g' }
  ];

  const steps = [
    {
      title: "CRÉMAGE.",
      text: "Mélanger le beurre pommade et le sucre cassonade jusqu'à obtenir une texture homogène."
    },
    {
      title: "AJOUT FARINE.",
      text: "Ajouter la farine et mélanger sans trop travailler la pâte pour ne pas la rendre élastique."
    },
    {
      title: "ABAISSE.",
      text: "Étaler finement (2-3mm) entre deux feuilles de papier cuisson."
    },
    {
      title: "REPOS.",
      text: "Placer au congélateur pour durcir la pâte."
    },
    {
      title: "DÉTAILLAGE.",
      text: "Détailler des disques ou carrés de la taille de vos choux."
    },
    {
      title: "UTILISATION.",
      text: "Placer sur la pâte à choux dressée juste avant la cuisson."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Coloration</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez colorer le craquelin avec du colorant en poudre pour varier les finitions.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Adhérence</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Écraser légèrement avant de poser sur la pâte à choux pour assurer que le craquelin ne tombe pas au four.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Indispensable pour des choux réguliers et esthétiques comme en boutique.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
