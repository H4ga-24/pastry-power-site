...
const MousseCaramel = () => {
  ...
  const steps = [
    ...
    { title: "DÉCUISSON", text: "Hors du feu, ajouter le beurre puis la crème tiède. Remettre sur feu doux si besoin pour lisser." },
    { title: "GÉLATINE", text: "Ajouter la gélatine essorée dans le caramel chaud." },
    { title: "JAUNES", text: "Incorporer les jaunes d'œufs un par un dans le caramel tiédi en fouettant vivement." },
    { title: "BLANCS", text: "Monter les blancs en neige ferme." },
    { title: "MÉLANGE", text: "Incorporer délicatement les blancs au mélange caramel." },
    { title: "REPOS", text: "Mettre au frais 3h minimum." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Faites attention à ne pas cuire les œufs dans le caramel : il doit avoir tiédi.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Pour une texture plus mousseuse, utilisez uniquement les blancs d'œufs.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
