...
const InsertCremeBrulee = () => {
  ...
  const steps = [
    { title: "INFUSION", text: "Chauffer la crème et le lait avec la vanille. Laisser infuser 15 min." },
    { title: "BLANCHIR", text: "Fouetter les jaunes et le sucre." },
    { title: "CUISSON", text: "Verser le liquide chaud sur les jaunes, remettre sur feu doux et cuire à la nappe (82°C) comme une crème anglaise." },
    { title: "GÉLATINE", text: "Ajouter la gélatine hydratée hors du feu. Mixer." },
    { title: "MOULAGE", text: "Couler dans l'insert et congeler. (L'étape de brûlage au chalumeau n'est pas possible pour un insert)." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La gélatine est ajoutée pour que l'insert se tienne à la découpe, mais la quantité reste faible pour garder le crémeux.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Four</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez aussi cuire la crème au four à 100°C dans le moule insert, puis congeler une fois refroidi.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
