...
const CremeAnglaise = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "Une sauce onctueuse à la vanille, base des îles flottantes, des glaces et parfaite pour accompagner les fondants au chocolat.",
  ...
  const steps = [
    {
      title: "INFUSION.",
      text: "Fendre la gousse de vanille et gratter les grains. Mettre le tout dans le lait et porter à ébullition. Laisser infuser 10 min hors du feu."
    },
    {
      title: "BLANCHIR.",
      text: "Fouetter les jaunes d'oeufs avec le sucre jusqu'à ce que le mélange blanchisse légèrement."
    },
    {
      title: "MÉLANGE.",
      text: "Verser le lait chaud (débarrassé de la gousse si souhaité) sur les jaunes tout en fouettant."
    },
    {
      title: "CUISSON À LA NAPPE.",
      text: "Reverser le tout dans la casserole. Cuire à feu doux en remuant sans cesse avec une spatule (vanner) jusqu'à atteindre 82°C-84°C. La crème doit napper la cuillère."
    },
    {
      title: "ARRÊT CUISSON.",
      text: "Dès la température atteinte, passer au chinois (tamis) dans un récipient froid pour stopper la cuisson immédiatement."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Attention à la température</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ne dépassez jamais 84°C, sinon les jaunes d'oeufs coagulent et la crème forme des grumeaux (elle "brosse").</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
