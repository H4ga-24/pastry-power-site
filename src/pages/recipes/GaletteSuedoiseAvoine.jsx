...
const GaletteSuedoiseAvoine = () => {
  const baseServings = 20;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • PETITS FOURS SECS",
    title: "Galette suédoise à l'avoine",
    prepTime: "10 MIN",
    cookTime: "8 MIN",
    difficulty: "TRÈS FACILE",
    description: "Des galettes ultra fines, croustillantes et dentelées, au bon goût d'avoine caramélisé. Comme chez IKEA !",
    image: "https://3.bp.blogspot.com/-QEVUCRs1y2w/Ty6GZ7uMBvI/AAAAAAAAMwk/FoTSVqTXnSU/s1600/IMG_5228.jpg",
  };

  const ingredients = [
    { name: 'Beurre', amount: 150, unit: 'g' },
    { name: 'Flocons d\'avoine', amount: 150, unit: 'g' },
    { name: 'Sucre', amount: 200, unit: 'g' },
    { name: 'Farine', amount: 50, unit: 'g' },
    { name: 'Oeuf', amount: 1, unit: 'pc' },
    { name: 'Levure chimique', amount: 1, unit: 'cc' },
    { name: 'Vanille', amount: 1, unit: 'cc' }
  ];

  const steps = [
    { title: "BEURRE", text: "Faire fondre le beurre et le verser sur les flocons d'avoine. Mélanger." },
    { title: "APPAREIL", text: "Fouetter l'œuf avec le sucre jusqu'à blanchiment. Ajouter la farine, la levure et la vanille." },
    { title: "MÉLANGE", text: "Incorporer le mélange beurre/avoine." },
    { title: "DRESSAGE", text: "Déposer des petits tas très espacés sur une plaque (ils vont beaucoup s'étaler)." },
    { title: "CUISSON", text: "Cuire à 200°C pendant 6 à 8 minutes. Surveiller la coloration." }
  ];
...
export default GaletteSuedoiseAvoine;