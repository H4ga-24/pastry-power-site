...
const BiscuitAuMarron = () => {
  ...
  const recipeData = {
    ...
    cookTime: "30 MIN",
    difficulty: "MOYEN",
    description: "Un biscuit moelleux aux saveurs d'automne, avec de la crème de marron.",
    image: "https://liliebakery.fr/wp-content/uploads/2022/11/Recette-gateau-creme-de-marron-facile-Lilie-Bakery.jpg",
  };

  const ingredients = [
    { name: 'Crème de marron', amount: 250, unit: 'g' },
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Mélanger la crème de marron et le beurre fondu." },
    { title: "OEUFS", text: "Incorporer les jaunes d'oeufs un par un." },
    { title: "POUDRES", text: "Ajouter la farine et la levure." },
    { title: "BLANCS", text: "Monter les blancs en neige et les incorporer délicatement." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 30 minutes." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 gâteau</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le biscuit reste humide grâce à la crème de marron.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Délicieux avec une crème anglaise ou un glaçage chocolat.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
