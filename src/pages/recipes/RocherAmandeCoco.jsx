...
const RocherAmandeCoco = () => {
  ...
  const ingredients = [
    ...
    { name: 'Miel (facultatif)', amount: 1, unit: 'cs' }
  ];

  const steps = [
    { title: "MÉLANGE", text: "Mélanger le sucre avec les fruits secs choisis (amandes hachées ou coco)." },
    { title: "LIAISON", text: "Ajouter les blancs d'œufs, la vanille et le miel. Mélanger jusqu'à obtenir une pâte compacte." },
    { title: "FAÇONNAGE", text: "Former des petits tas irréguliers sur une plaque de cuisson." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 12 à 15 minutes jusqu'à ce qu'ils soient bien dorés." }
  ];
