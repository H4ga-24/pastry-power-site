...
const CremeuxExotique = () => {
  ...
  const ingredients = [
    { name: 'Purée de fruits exotiques', amount: 250, unit: 'g' },
  ...
  const steps = [
    ...
    { title: "Cuisson", text: "Chauffer la purée de fruits. Mélanger les œufs, les jaunes et le sucre. Verser la purée chaude dessus et cuire le tout à la nappe (83°C)." },
    { title: "Collage", text: "Hors du feu, ajouter la gélatine essorée. Mélanger et laisser tiédir à 40°C." },
    { title: "Emulsion", text: "Incorporer le beurre froid coupé en dés et mixer longuement au mixeur plongeant sans incorporer d'air." },
    { title: "Finition", text: "Couler immédiatement dans les contenants choisis (insert ou verrine)." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Mélange de fruits</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le mélange classique 'exotique' contient souvent mangue, passion, banane et citron vert. Vous pouvez varier les plaisirs avec de l'ananas ou de la goyave.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Zestes</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des zestes de citron vert finement râpés en fin de mélange pour une note de fraîcheur supplémentaire.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
