...
const CremeuxVanilleChocolatBlanc = () => {
  ...
  const steps = [
    { title: "Préparation", text: "Hydrater la gélatine. Hacher le chocolat blanc s'il n'est pas en pistoles." },
    { title: "Infusion", text: "Chauffer le lait et la crème avec la gousse de vanille grattée. Laisser infuser 10 min à couvert." },
    { title: "Cuisson", text: "Réaliser une crème anglaise : verser le liquide chaud sur les jaunes et le sucre mélangés, puis cuire à 83°C." },
    { title: "Mélange", text: "Ajouter la gélatine essorée hors du feu. Verser sur le chocolat blanc en 3 fois." },
    { title: "Emulsion", text: "Mixer au mixeur plongeant pour obtenir une texture parfaitement lisse et brillante." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le chocolat blanc contient déjà du beurre de cacao. Si vous souhaitez un crémeux très souple, vous pouvez réduire la gélatine à 2g.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Vanille</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez la gousse épuisée (séchée et mixée) pour renforcer le goût si vous en avez en stock.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
