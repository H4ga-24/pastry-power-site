...
const MuffinsChocolatNoisette = () => {
  ...
  const ingredients = [
    ...
    { name: "Cacao poudre", amount: "30g" },
    { name: "Levure chimique", amount: "11g" },
    { name: "Sucre", amount: "100g" },
    { name: "Oeufs", amount: "2" },
    { name: "Lait", amount: "200ml" },
    { name: "Huile végétale", amount: "80ml" },
    { name: "Pépites chocolat", amount: "100g" },
    { name: "Noisettes concassées", amount: "50g" }
  ];

  const steps = [
    { title: "Mélange Sec", text: "Dans un grand bol, mélanger la farine, le cacao, la levure chimique et le sucre." },
    { title: "Mélange Liquide", text: "Dans un autre bol, battre les œufs avec le lait et l'huile." },
    { title: "Assemblage", text: "Verser les liquides sur les secs. Mélanger grossièrement à la spatule (il doit rester des grumeaux). Ajouter les pépites et les noisettes." },
    { title: "Cuisson", text: "Remplir les moules à muffins aux 3/4. Cuire à 200°C pendant 20 minutes." }
  ];
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>Le secret des muffins gonflés : ne travaillez pas trop la pâte ! Il faut juste humidifier les ingrédients secs.</li>
                           <li>Torréfiez les noisettes quelques minutes au four avant de les concasser, elles auront plus de goût.</li>
                           <li>Utilisez de l'huile neutre (pépin de raisin ou tournesol) pour plus de moelleux.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "Contrairement aux cakes, les muffins doivent être enfournés à haute température pour bien développer leur dôme caractéristique. Ne baissez pas le four !"
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-2 text-gray-400">
                          ...
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Caissettes papier</li>
