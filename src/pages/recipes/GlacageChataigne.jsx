                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si le glaçage est trop épais à cause de la pâte de marron, n'hésitez pas à le détendre avec un peu de sirop à 30°B ou d'eau tiède lors du mixage final.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
