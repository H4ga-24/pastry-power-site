...
const Clafoutis = () => {
  const recipeData = {
    ...
    cookTime: "45 MIN",
    difficulty: "FACILE",
    description: "Le dessert rustique par excellence, où les cerises gardent tout leur jus.",
  ...
  const ingredients = [
    { name: "Cerises (non dénoyautées)", amount: "500g" },
    { name: "Oeufs", amount: "4" },
    { name: "Sucre semoule", amount: "100g" },
    { name: "Farine T55", amount: "100g" },
    { name: "Lait entier", amount: "250ml" },
    { name: "Beurre fondu", amount: "40g" },
    { name: "Extrait de vanille", amount: "1 càc" }
  ];

  const steps = [
    { title: "Préparation", text: "Laver et équeuter les cerises. Garder les noyaux donne plus de goût et empêche le jus de détremper la pâte." },
    { title: "Appareil", text: "Fouetter les œufs et le sucre. Ajouter la farine, puis le beurre fondu et le lait petit à petit." },
    { title: "Cuisson", text: "Disposer les cerises dans un plat beurré. Verser l'appareil dessus. Cuire 45 min à 180°C." }
  ];
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>Pour un clafoutis plus crémeux, remplacez la moitié du lait par de la crème liquide.</li>
                           <li>Saupoudrez de sucre vanillé à la sortie du four pour une croûte parfumée.</li>
                           <li>Si vous dénoyautez les cerises, le jus va détremper la pâte et le clafoutis sera moins beau.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "Le vrai clafoutis limousin se fait avec des cerises noires et entières. Le noyau communique au fruit et à la pâte une saveur boisée inimitable à la cuisson."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-2 text-gray-400">
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Plat à gratin</li>
