...
const InsertRizSouffleCaramelise = () => {
  ...
  const steps = [
    { title: "CARAMEL", text: "Réaliser un caramel à sec avec le sucre." },
    { title: "ENROBAGE", text: "Ajouter le beurre pour arrêter la cuisson, puis verser immédiatement sur le riz soufflé." },
    { title: "MÉLANGE", text: "Mélanger délicatement pour enrober chaque grain sans les écraser." },
    { title: "LIANT", text: "Une fois tiédi, ajouter le chocolat au lait fondu pour lier l'ensemble." },
    { title: "MOULAGE", text: "Tasser la préparation dans le fond d'un cercle ou d'un moule. Réserver au frais pour figer." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le chocolat sert à imperméabiliser le riz soufflé pour qu'il reste croustillant même après décongélation.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Remplacez le riz soufflé par des pétales de maïs concassés (corn flakes) pour une texture différente.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
