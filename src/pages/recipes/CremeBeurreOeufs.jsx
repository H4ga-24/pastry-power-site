...
const CremeBeurreOeufs = () => {
  ...
  const recipeData = {
    ...
    title: "Crème au beurre aux oeufs",
    prepTime: "25 MIN",
    cookTime: "10 MIN",
    difficulty: "MOYEN",
  ...
  const steps = [
    ...
    },
    {
      ...
      text: "Continuer de fouetter jusqu'à ce que le mélange double de volume et refroidisse."
    },
    {
      title: "INCORPORATION.",
      text: "Incorporer progressivement le beurre pommade tout en fouettant jusqu'à l'obtention d'une crème lisse."
    }
  ];
                 ...
                 <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Goût</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Cette crème est plus jaune et plus riche en goût que celle à la meringue italienne, parfaite pour les parfums café, chocolat ou praliné.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
