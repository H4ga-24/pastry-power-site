...
const CremeuxVanille = () => {
  ...
  const ingredients = [
    ...
    { name: 'Gousses de vanille', amount: 2, unit: 'pcs' },
    { name: 'Beurre doux', amount: 40, unit: 'g' }
  ];

  const steps = [
    { title: "Infusion", text: "Chauffer le lait et la crème avec les gousses de vanille grattées. Laisser infuser 30 min à couvert pour développer les arômes." },
    { title: "Cuisson", text: "Chauffer à nouveau. Verser sur les jaunes et le sucre blanchis. Cuire à la nappe à 83°C." },
    { title: "Collage", text: "Ajouter la gélatine essorée hors du feu. Chinoiser la préparation." },
    { title: "Finition", text: "Lorsque la crème atteint 40°C, ajouter le beurre et mixer pour lisser et donner du brillant." },
    { title: "Repos", text: "Filmer au contact et réserver au frais." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Variétés</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Variez les plaisirs en utilisant différentes vanilles : Bourbon pour le classique, Tahiti pour le floral, ou Mexique pour le boisé.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Mascarpone</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez remplacer une partie de la crème par du mascarpone pour un crémeux encore plus riche.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
