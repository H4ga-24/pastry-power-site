...
const InsertPralineFruitsSecs = () => {
  ...
  const steps = [
    { title: "TORRÉFACTION", text: "Torréfier les noisettes et amandes au four à 150°C pendant 15 min. Hacher grossièrement." },
    { title: "FONTE", text: "Fondre le chocolat au lait et le beurre de cacao ensemble." },
    { title: "MÉLANGE", text: "Incorporer le praliné au chocolat fondu." },
    { title: "AJOUTS", text: "Ajouter les fruits secs hachés et mélanger." },
    { title: "COULAGE", text: "Couler dans le moule insert et faire prendre au froid." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le chocolat et le beurre de cacao imperméabilisent les fruits secs pour qu'ils restent croquants.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez un praliné maison à 60% de fruits minimum pour un goût incomparable.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
