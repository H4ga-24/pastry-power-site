...
const MousseFraise = () => {
  ...
  const steps = [
    ...
    { title: "CHAUFFE", text: "Chauffer un tiers de la purée de fraise avec le sucre." },
    { title: "COLLAGE", text: "Ajouter la gélatine essorée hors du feu. Ajouter le reste de purée froide et le citron." },
    { title: "MONTAGE", text: "Fouetter la crème en chantilly mousseuse." },
    { title: "MÉLANGE", text: "Incorporer la crème à la purée gélifiée refroidie (20-25°C)." },
    { title: "FINITION", text: "Garnir votre entremets ou verrines." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez des fraises type Mara des Bois ou Gariguette pour plus de parfum.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Un trait de jus de citron aide à rehausser le goût de la fraise.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
