...
const MousseCaramelBeurreSale = () => {
  ...
  const steps = [
    { title: "CARAMEL", text: "Faire un caramel à sec avec le sucre jusqu'à couleur ambrée." },
    { title: "DÉCUISSON", text: "Ajouter le beurre en morceaux puis la crème chaude (100ml) en faisant attention aux projections." },
    { title: "GÉLATINE", text: "Ajouter la gélatine ramollie dans le caramel chaud. Ajouter la fleur de sel. Laisser tiédir." },
    { title: "CHANTILLY", text: "Monter le reste de la crème (200ml) en chantilly pas trop ferme." },
    { title: "MÉLANGE", text: "Incorporer délicatement la chantilly au caramel tiédi (environ 30°C)." },
    { title: "FINITION", text: "Verser en verrines et laisser prendre au frais." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si le caramel est trop chaud, la chantilly va fondre. S'il est trop froid, il va figer en grains.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Poussez le caramel assez loin (couleur foncée) pour que le goût ressorte malgré la crème.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
