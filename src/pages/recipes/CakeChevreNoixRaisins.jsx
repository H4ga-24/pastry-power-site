...
const CakeChevreNoixRaisins = () => {
  const ingredients = [
    ...
    { name: "Noix", amount: "50g" },
    { name: "Raisins secs", amount: "50g" },
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake Chèvre Noix Raisins - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake Chèvre Noix" src="https://img.cuisineaz.com/660x660/2018/10/01/i143099-cake-chevre-noix-et-raisins.jpeg" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake Chèvre, Noix & Raisins</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Préchauffez le four à 180°C. Coupez le fromage de chèvre en dés et concassez grossièrement les noix.</p>
              <p><span className="text-[#D4AF37] font-bold">2.</span> Dans un saladier, mélangez la farine et la levure chimique.</p>
              <p><span className="text-[#D4AF37] font-bold">3.</span> Ajoutez les œufs, l'huile et le lait. Mélangez jusqu'à l'obtention d'une pâte homogène.</p>
              <p><span className="text-[#D4AF37] font-bold">4.</span> Incorporez le gruyère râpé, les dés de chèvre, les noix et les raisins secs. Salez et poivrez légèrement.</p>
