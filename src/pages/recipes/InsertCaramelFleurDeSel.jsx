...
const InsertCaramelFleurDeSel = () => {
  ...
  const steps = [
    { title: "CARAMEL", text: "Réaliser un caramel à sec avec le sucre dans une casserole à fond épais jusqu'à une couleur ambrée." },
    { title: "DÉCUISSON", text: "Chauffer la crème liquide. Verser doucement sur le caramel hors du feu pour décuire (attention aux projections)." },
    { title: "CUISSON", text: "Remettre sur feu doux pour bien dissoudre les éventuels morceaux de sucre. Cuire jusqu'à nappage." },
    { title: "FINITION", text: "Hors du feu, ajouter le beurre, la fleur de sel et la gélatine préalablement hydratée." },
    { title: "MOULAGE", text: "Couler dans un cercle ou moule à insert de diamètre inférieur à votre entremets. Congeler." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Adaptez la quantité de gélatine selon si vous souhaitez un cœur très coulant ou un insert qui se tient à la découpe.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Congélation</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Il est impératif de congeler l'insert à cœur (au moins 4h) pour pouvoir le manipuler et l'insérer proprement dans l'entremets.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
