...
const MousseAbricot = () => {
  ...
  const steps = [
    { title: "HYDRATATION", text: "Faire tremper la gélatine dans un grand bol d'eau froide." },
    { title: "CHAUFFE", text: "Chauffer 1/3 de la purée d'abricot avec le sucre. Hors du feu, ajouter la gélatine essorée." },
    { title: "MÉLANGE", text: "Verser le mélange chaud dans le reste de la purée froide. Laisser tiédir à 25-30°C." },
    { title: "CHANTILLY", text: "Monter la crème liquide bien froide en chantilly souple avec le sucre glace." },
    { title: "INCORPORATION", text: "Incorporer délicatement la chantilly à la purée gélifiée à l'aide d'une maryse." },
    { title: "DRESSAGE", text: "Couler immédiatement dans vos moules ou verrines." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Renforcez le goût avec un trait de liqueur d'abricot si souhaité.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Pour une mousse plus ferme, utilisez de la meringue italienne au lieu du sucre glace.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
