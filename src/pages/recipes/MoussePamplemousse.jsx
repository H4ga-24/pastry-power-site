...
const MoussePamplemousse = () => {
  ...
  const steps = [
    { title: "GÉLATINE", text: "Réhydrater la gélatine dans un bol d'eau froide." },
    { title: "CHAUFFE", text: "Chauffer un tiers du jus de pamplemousse avec le sucre." },
    { title: "COLLAGE", text: "Ajouter la gélatine essorée. Mélanger avec le reste de jus froid." },
    { title: "MONTAGE", text: "Monter la crème en chantilly avec le sucre glace." },
    { title: "MÉLANGE", text: "Incorporer délicatement la chantilly au jus gélifié refroidi." },
    { title: "FINITION", text: "Couler en verrines ou utiliser pour un entremets." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Amertume</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si le pamplemousse est trop amer, n'hésitez pas à augmenter légèrement la quantité de sucre.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Suprêmes</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Décorez avec des suprêmes de pamplemousse frais pour le visuel.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
