...
const CakeMarbre = () => {
  ...
  const ingredients = [
    { name: "Beurre pommade", amount: "150g" },
    { name: "Sucre glace", amount: "150g" },
    { name: "Poudre d'amande", amount: "30g" },
    { name: "Oeufs entiers", amount: "165g (3)" },
    { name: "Farine T55", amount: "180g" },
    { name: "Levure chimique", amount: "6g" },
    { name: "Crème liquide 35%", amount: "80g" },
    { name: "Cacao poudre", amount: "20g" },
    { name: "Extrait de vanille", amount: "1 càc" }
  ];

  const steps = [
    { title: "Crémage", text: "Mélanger le beurre pommade avec le sucre glace et la poudre d'amande jusqu'à obtenir une texture crémeuse." },
    { title: "Oeufs", text: "Incorporer les œufs un par un en émulsionnant bien entre chaque ajout." },
    { title: "Poudres et Liquide", text: "Ajouter la farine tamisée avec la levure, puis détendre avec la crème liquide." },
    { title: "Séparation", text: "Diviser la pâte en deux (2/3 nature, 1/3 cacao). Ajouter la vanille dans la partie nature, et le cacao tamisé dans l'autre." },
    { title: "Marbrage", text: "Dans un moule beurré, alterner les couches de pâte ou pocher des boudins. Passer la lame d'un couteau pour créer le marbrage." },
    { title: "Cuisson", text: "Cuire à 160°C pendant environ 45 à 50 minutes." }
  ];
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>Préparez un sirop léger (eau + sucre) parfumé à la vanille et imbibez le cake dès la sortie du four pour qu'il reste ultra-moelleux.</li>
                           <li>Pour obtenir la belle fissure caractéristique sur le dessus, pochez un filet de beurre pommade au centre du cake sur toute la longueur avant d'enfourner.</li>
                           <li>Assurez-vous que tous les ingrédients soient à température ambiante pour éviter que l'appareil ne tranche.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "La clé d'un marbré réussi réside dans l'équilibre des textures. Ne travaillez pas trop la pâte une fois la farine ajoutée, sinon votre cake sera élastique et sec."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-2 text-gray-400">
                          ...
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Cul de poule x2</li>
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Fouet</li>
                          <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full"></div>Poches à douille (opt)</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
