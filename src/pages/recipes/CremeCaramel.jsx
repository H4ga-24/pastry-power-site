...
const CremeCaramel = () => {
  ...
  const ingredients = [
    ...
    { name: 'Jaunes d\'oeufs', amount: 2, unit: 'pc' },
    { name: 'Sucre semoule (crème)', amount: 80, unit: 'g' },
    { name: 'Sucre semoule (caramel)', amount: 100, unit: 'g' },
    { name: 'Eau (caramel)', amount: 20, unit: 'g' },
  ...
  const steps = [
    {
      title: "CARAMEL.",
      text: "Cuire le sucre et l'eau jusqu'à obtention d'un caramel ambré. Verser immédiatement au fond des ramequins."
    },
    {
      title: "INFUSION.",
    ...
    {
      title: "APPAREIL.",
      text: "Fouetter les oeufs, les jaunes et le sucre (crème) sans faire mousser. Verser le lait chaud dessus."
    },
    {
      title: "REMPLISSAGE.",
      text: "Verser l'appareil filtré dans les ramequins sur le caramel durci."
    },
    {
      title: "CUISSON.",
      text: "Cuire au bain-marie au four à 150°C pendant 30 à 40 minutes. La crème doit être tremblotante."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Bulles</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour éviter les bulles dans la crème, ne fouettez pas l'appareil et laissez-le reposer avant de le verser. Cuisez doucement.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
