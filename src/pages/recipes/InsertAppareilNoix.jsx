...
const InsertAppareilNoix = () => {
  ...
  const steps = [
    { title: "TORRÉFACTION", text: "Torréfier les noix au four à 160°C pendant 10-15 min. Les concasser grossièrement." },
    { title: "CARAMEL", text: "Dans une casserole, cuire le sucre et le miel jusqu'à obtenir un caramel blond." },
    { title: "DÉCUISSON", text: "Décuire avec la crème liquide chaude et le beurre." },
    { title: "MÉLANGE", text: "Ajouter les noix torréfiées et cuire quelques minutes à feu doux pour enrober." },
    { title: "REFROIDISSEMENT", text: "Couler dans des moules ou sur un fond de tarte et laisser refroidir." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Noix</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Privilégiez les noix de Grenoble ou du Périgord pour un goût plus fin.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Une pointe de café soluble dans le caramel se marie très bien avec la noix.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
