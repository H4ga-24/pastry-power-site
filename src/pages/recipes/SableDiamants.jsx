...
const SableDiamants = () => {
  ...
  const steps = [
    { title: "CRÉMAGE", text: "Mélanger le beurre pommade avec le sucre glace et la vanille." },
    { title: "LIAISON", text: "Ajouter le jaune d'œuf." },
    { title: "FARINE", text: "Incorporer la farine rapidement sans corser la pâte." },
    { title: "ROULAGE", text: "Former des boudins réguliers d'environ 4cm de diamètre. Filmer et réfrigérer 1h." },
    { title: "FINITION", text: "Badigeonner les boudins d'un peu d'eau ou de blanc d'œuf, puis les rouler dans le sucre cristal." },
    { title: "DÉCOUPE", text: "Couper des tranches de 1cm d'épaisseur." },
    { title: "CUISSON", text: "Cuire à 170°C pendant 15 minutes. Les bords doivent être dorés." }
  ];
