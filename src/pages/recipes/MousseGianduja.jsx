...
const MousseGianduja = () => {
  ...
  const ingredients = [
    ...
    { name: 'Gélatine (facultatif)', amount: 2, unit: 'g' }
  ];

  const steps = [
    { title: "FONTE", text: "Faire fondre le Gianduja avec les 100ml de crème chaude." },
    { title: "GÉLATINE", text: "Si utilisation en entremets, ajouter la gélatine hydratée dans le mélange chaud." },
    { title: "REFROIDISSEMENT", text: "Laisser tiédir le mélange autour de 30°C-35°C." },
    { title: "CRÈME FOUETTÉE", text: "Monter les 300ml de crème liquide en chantilly mousseuse." },
    { title: "MÉLANGE", text: "Incorporer délicatement la chantilly au mélange Gianduja." },
    { title: "DRESSAGE", text: "Couler en cercle ou en verrines et laisser prendre au froid." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 entremets</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez un peu d'éclats de noisettes torréfiées pour du croquant.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Gianduja maison</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez le faire vous-même en mixant tant pour tant noisettes torréfiées et sucre glace jusqu'à obtenir une pâte, puis ajouter du chocolat au lait fondu.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
