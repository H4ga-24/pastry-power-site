...
const MousseFromageBlanc = () => {
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Fouetter le fromage blanc pour le lisser avec les graines de vanille et le zeste." },
    { title: "CHANTILLY", text: "Monter la crème liquide bien froide en chantilly ferme avec le sucre glace." },
    { title: "MÉLANGE", text: "Incorporer délicatement la chantilly au fromage blanc à l'aide d'une maryse." },
    { title: "DRESSAGE", text: "Dresser en coupes ou verrines." },
    { title: "REPOS", text: "Réserver au frais 2h avant de servir." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Égouttage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si votre fromage blanc est trop liquide, égouttez-le 30min dans une passoire fine avant utilisation.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Légèreté</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour une version encore plus aérienne, vous pouvez ajouter un blanc d'œuf monté en neige.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
