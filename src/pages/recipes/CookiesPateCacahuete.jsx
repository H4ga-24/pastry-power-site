...
const CookiesPateCacahuete = () => {
  const baseServings = 15;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • PETITS FOURS SECS",
    title: "Cookies pâte de cacahuète",
    prepTime: "15 MIN",
    cookTime: "12 MIN",
    difficulty: "TRÈS FACILE",
    description: "Des cookies ultra gourmands, riches en beurre de cacahuète et pépites de chocolat.",
    image: "https://www.lesrecettesdevanessa.fr/wp-content/uploads/2021/04/Recette-Cookie-cacahuete-chocolat_-les-recettes-de-vanessa.jpg",
  };

  const ingredients = [
    { name: 'Beurre de cacahuète', amount: 150, unit: 'g' },
    { name: 'Beurre mou', amount: 100, unit: 'g' },
    { name: 'Sucre cassonade', amount: 120, unit: 'g' },
    { name: 'Sucre blanc', amount: 50, unit: 'g' },
    { name: 'Œuf', amount: 1, unit: 'pc' },
    { name: 'Farine', amount: 180, unit: 'g' },
    { name: 'Levure chimique', amount: 0.5, unit: 'cc' },
    { name: 'Pépites de chocolat', amount: 100, unit: 'g' }
  ];

  const steps = [
    { title: "CRÉMAGE", text: "Mélanger le beurre mou, le beurre de cacahuète et les sucres." },
    { title: "OEUF", text: "Ajouter l'œuf et mélanger vigoureusement." },
    { title: "SECS", text: "Incorporer la farine et la levure." },
    { title: "GARNITURE", text: "Ajouter les pépites de chocolat." },
    { title: "FAÇONNAGE", text: "Former des boules de pâte, les disposer sur une plaque et les aplatir légèrement." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 10 à 12 minutes. Les bords doivent être dorés." }
  ];
...
export default CookiesPateCacahuete;