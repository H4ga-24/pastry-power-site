...
const CremeBavaroiseChocolatCannelle = () => {
  ...
  const ingredients = [
    ...
    { name: 'Bâton de cannelle', amount: 1, unit: 'pc' },
  ...
  const steps = [
    ...
    {
      title: "ANGLAISE.",
      text: "Retirer la cannelle. Fouetter les jaunes et le sucre, verser le lait chaud dessus. Cuire à la nappe (83°C)."
    },
    {
      title: "CHOCOLAT.",
      text: "Verser la crème anglaise chaude sur le chocolat noir haché. Laisser fondre et lisser."
    },
    {
      title: "GÉLATINE.",
      text: "Incorporer la gélatine réhydratée au mélange chaud. Bien mélanger."
    },
    {
      title: "FINITION.",
      text: "Laisser refroidir à 30°C puis incorporer délicatement la crème fouettée mousseuse."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Épices</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La cannelle peut être remplacée par de la fève tonka râpée ou de la badiane pour varier les plaisirs.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
