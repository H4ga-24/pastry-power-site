...
const BiscuitMacaronCachemire = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit macaron cachemire",
    prepTime: "20 MIN",
    cookTime: "12 MIN",
    difficulty: "MOYEN",
    description: "Un biscuit façon macaron, moelleux à cœur et légèrement croustillant sur le dessus.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/07/biscuit-macaron-cachemire.jpg",
  };

  const ingredients = [
    { name: 'Beurre Emul', amount: 150, unit: 'g' },
    { name: 'Sucre noisette', amount: 125, unit: 'g' },
    { name: 'Sucre Cassonade', amount: 125, unit: 'g' },
    { name: 'Poudre Amande', amount: 150, unit: 'g' },
  ...
  const steps = [
    {
      title: "CRÉMAGE.",
      text: "Mélanger le beurre pommade (Emul) et les sucres (noisette et cassonade) jusqu'à obtenir une texture crémeuse."
    },
    {
      title: "AMANDES.",
      text: "Ajouter la poudre d'amande et mélanger délicatement."
    },
    {
      title: "FINITION APPAREIL.",
      text: "Incorporer le sucre glace tamisé pour lisser la préparation."
    },
    {
      title: "DRESSAGE.",
      text: "Former les macarons sur une plaque de cuisson à l'aide d'une poche à douille."
    },
    {
      title: "CUISSON.",
      text: "Cuire 12 min à four chaud (température standard 160°C - 170°C)."
    },
    {
      title: "SERVICE.",
      text: "Laisser refroidir, garnir selon vos envies et servir."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ne travaillez pas trop la pâte une fois la poudre d'amande ajoutée pour garder du corps.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ce biscuit se conserve bien dans une boîte hermétique à l'abri de l'humidité.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'association des deux sucres apporte une complexité aromatique intéressante au biscuit.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitMacaronCachemire;