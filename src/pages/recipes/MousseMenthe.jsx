...
const MousseMenthe = () => {
  ...
  const ingredients = [
    ...
    { name: 'Menthe fraîche (bottte)', amount: 1, unit: 'pc' },
  ...
  const steps = [
    { title: "INFUSION", text: "Faire bouillir le lait, ajouter la menthe, couvrir et laisser infuser 15 min." },
    { title: "ANGLAISE", text: "Filtrer, réchauffer le lait. Verser sur le mélange jaunes/sucre. Cuire à la nappe (82°C)." },
    { title: "COLLAGE", text: "Ajouter la gélatine essorée dans la crème anglaise chaude. Laisser refroidir." },
    { title: "MONTAGE", text: "Monter la crème liquide en chantilly." },
    { title: "MÉLANGE", text: "Incorporer la chantilly à la crème anglaise menthe refroidie (25°C)." },
    { title: "FINITION", text: "Utiliser immédiatement." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Fraîcheur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez de la menthe poivrée pour un goût plus prononcé, ou de la menthe verte pour plus de douceur.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'infusion reste pâle, une pointe de colorant vert peut être ajoutée pour l'esthétique.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
