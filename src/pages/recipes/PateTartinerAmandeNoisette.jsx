...
const PateTartinerAmandeNoisette = () => {
  const recipeData = {
    category: "CONFISERIE • AUTRES", // 👈 CORRIGÉ SELON TA DEMANDE
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed">
                           <li>La torréfaction est l'étape cruciale : plus les fruits secs sont grillés (sans brûler), plus le goût de noisette sera puissant.</li>
                           <li>L'huile de pépin de raisin est choisie pour sa neutralité. Vous pouvez la remplacer par une huile de noisette pour renforcer le goût.</li>
                           <li>La poudre de lait n'est pas obligatoire mais elle apporte ce côté lacté et crémeux typique des pâtes à tartiner industrielles, sans les mauvais additifs.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic">
                          "Une fois que vous aurez goûté à ce praliné 'minute' encore tiède, vous ne pourrez plus jamais acheter un pot industriel. C'est l'essence même du fruit sec que l'on capture ici."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
