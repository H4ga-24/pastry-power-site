...
const BiscuitJocondeImpression = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit joconde (impression)",
    prepTime: "30 MIN",
    cookTime: "12 MIN",
    difficulty: "AVANCÉ",
    description: "On peut utiliser ce biscuit, pour réaliser le biscuit impression ou décors, en faisant retomber légèrement l'appareil pour éviter les bulles sur l'impression.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2021/09/IMG-20210928-WA0018-975x1300.jpg",
  };

  const ingredients = [
    { name: 'Poudre amande', amount: 250, unit: 'g' },
    { name: 'Sucre glace', amount: 250, unit: 'g' },
    { name: 'Blancs d\'oeuf', amount: 100, unit: 'g' },
    { name: 'Beurre', amount: 50, unit: 'g' },
    { name: 'Farine T55', amount: 50, unit: 'g' },
    { name: 'Blancs (meringue)', amount: 100, unit: 'g' },
  ...
  const steps = [
    {
      title: "TPT.",
      text: "Mélanger la poudre d'amande et le sucre glace."
    },
    {
      title: "INCORPORATION 1.",
      text: "Incorporer les premiers blancs."
    },
    {
      title: "BEURRE ET FARINE.",
      text: "Ajouter le beurre et la farine."
    },
    {
      title: "MERINGUE.",
      text: "Monter la meringue avec les seconds blancs et sucre."
    },
    {
      title: "MÉLANGE FINAL.",
      text: "Incorporer délicatement la meringue."
    },
    {
      title: "DRESSAGE.",
      text: "Étaler sur décor."
    },
    {
      title: "CUISSON.",
      text: "Cuire 12 min à 200°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Astuce</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Créer des motifs avec un peigne avant cuisson.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Assurez-vous que votre tapis décor est bien froid avant d'étaler l'appareil.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Idéal pour donner un look professionnel à vos entremets.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitJocondeImpression;