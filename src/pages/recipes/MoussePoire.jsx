...
const MoussePoire = () => {
  ...
  const steps = [
    ...
    { title: "COLLAGE", text: "Incorporer la gélatine essorée. Mélanger avec le reste de purée et l'alcool." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La poire Williams est la référence, mais la Comice est aussi très bonne.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des dés de poire pochés dans la mousse pour la texture.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
