...
const LaPateACrepes = () => {
  const baseServings = 15; // 15 Crêpes
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Beurre Noisette</h4>
                      <p className="text-gray-400 font-light leading-relaxed">L'ajout de beurre noisette apporte un goût incomparable et permet de moins graisser la poêle à la cuisson.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Grumeaux</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si malgré vos précautions il reste des grumeaux, passez simplement un coup de mixeur plongeant dans la pâte avant le repos.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
