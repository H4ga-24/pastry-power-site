...
const MousseCassis = () => {
  ...
  const steps = [
    { title: "HYDRATATION", text: "Faire tremper la gélatine dans l'eau froide." },
    { title: "COLLAGE", text: "Chauffer une partie de la purée de cassis, y dissoudre la gélatine. Mélanger au reste de la purée." },
    { title: "MERINGUE", text: "Préparer une meringue italienne (sucre cuit à 118°C versé sur les blancs)." },
    { title: "MÉLANGE 1", text: "Incorporer délicatement la meringue italienne à la purée gélifiée." },
    { title: "MÉLANGE 2", text: "Incorporer ensuite la crème fouettée." },
    { title: "DRESSAGE", text: "Utiliser immédiatement." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'ajout de meringue italienne donne une texture plus aérée que la crème seule, parfaite pour équilibrer l'acidité du cassis.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si le cassis est trop acide, augmentez légèrement la quantité de meringue.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
