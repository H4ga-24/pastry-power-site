...
const LesCookies = () => {
  ...
  const steps = [
    { title: "CRÉMAGE", text: "Mélanger le beurre mou avec la cassonade et le sucre semoule jusqu'à obtenir une texture homogène." },
    { title: "OEUF", text: "Ajouter l'œuf et mélanger." },
    { title: "SECS", text: "Incorporer la farine mélangée à la levure et au sel. Mélanger brièvement." },
    { title: "GARNITURE", text: "Ajouter les pépites de chocolat et mélanger rapidement pour les répartir." },
    { title: "FAÇONNAGE", text: "Former des boules de pâte d'environ 40-50g et les disposer espacées sur une plaque de cuisson." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 9 à 11 minutes. Les centres doivent paraître encore un peu mous à la sortie du four." }
  ];
