...
const MeringueFrancaise = () => {
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Commencer à fouetter les blancs d'oeufs à vitesse moyenne." },
    { title: "SERRAGE 1", text: "Dès que les blancs moussent, ajouter un tiers du sucre semoule." },
    { title: "SERRAGE 2", text: "Continuer de fouetter et ajouter le reste du sucre semoule progressivement pour obtenir un 'bec d'oiseau'." },
    { title: "INCORPORATION", text: "Incorporer délicatement le sucre glace tamisé à la maryse." },
    { title: "CUISSON", text: "Dresser sur plaque et cuire à 90°C - 100°C pendant 1h30 à 2h pour les dessécher." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 10 meringues</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Il est crucial que le bol et le fouet soient parfaitement propres et sans traces de gras.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si la meringue jaunit, c'est que le four est trop chaud. Baissez la température et prolongez le temps.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
