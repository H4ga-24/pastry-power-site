...
const MousseFramboise = () => {
  ...
  const steps = [
    ...
    { title: "CHAUFFE", text: "Chauffer un tiers de la purée avec le sucre." },
    { title: "COLLAGE", text: "Incorporer la gélatine. Mélanger avec le reste de purée." },
    { title: "MONTAGE", text: "Monter la crème en chantilly pas trop ferme." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème montée à la purée gélifiée." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Pépins</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si vous faites votre purée vous-même, pensez à bien la chinoiser pour retirer les pépins.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Décor</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Quelques framboises fraîches au cœur de la mousse apporteront une surprise agréable.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
