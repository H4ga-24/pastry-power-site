...
const MousseAnanas = () => {
  ...
  const steps = [
    { title: "GÉLATINE", text: "Réhydrater la gélatine dans l'eau froide." },
    { title: "CUISSON", text: "Si vous utilisez de l'ananas frais mixé, portez-le à ébullition 2 minutes pour neutraliser la broméline." },
    { title: "COLLAGE", text: "Ajouter le sucre et la gélatine essorée dans la purée chaude. Ajouter le rhum." },
    { title: "REFROIDISSEMENT", text: "Laisser refroidir jusqu'à ce que le mélange commence à épaissir légèrement." },
    { title: "MONTAGE", text: "Monter la crème en chantilly et l'incorporer délicatement à la purée gélifiée." },
    { title: "FINITION", text: "Couler en cercles ou verrines." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Les morceaux d'ananas frais non cuits détruiront votre gélification. Utilisez des fruits au sirop ou cuisez-les.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez des zestes de citron vert pour encore plus de pep's.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
