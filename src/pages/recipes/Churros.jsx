...
const Churros = () => {
  const baseServings = 4; // Personnes
  ...
  const ingredients = [
    ...
    { name: 'Huile (pâte)', amount: 10, unit: 'g' },
    { name: 'Huile de friture', amount: 1, unit: 'L' },
    { name: 'Sucre semoule', amount: 100, unit: 'g' },
    { name: 'Cannelle en poudre', amount: 5, unit: 'g' }
  ];

  const steps = [
    {
      title: "La Pâte",
      text: "Portez à ébullition l'eau, le sel et l'huile. Versez l'eau bouillante directement sur la farine dans un cul de poule. Mélangez vigoureusement à la spatule jusqu'à obtenir une pâte épaisse et homogène sans grumeaux. Laissez tiédir légèrement."
    },
    {
      title: "Préparation",
      text: "Mettez la pâte dans une poche munie d'une douille cannelée solide (étoile). Attention, la pâte est compacte, utilisez une poche résistante."
    },
    {
      title: "Cuisson",
      text: "Chauffez l'huile de friture à 180°C. Pressez des bâtonnets de pâte au-dessus du bain d'huile et coupez-les aux ciseaux à la longueur souhaitée (10-12 cm). Ne surchargez pas la friteuse."
    },
    {
      title: "Finition",
      text: "Faites frire 3 à 4 minutes jusqu'à ce qu'ils soient bien dorés. Égouttez sur du papier absorbant et roulez-les immédiatement dans le mélange sucre-cannelle."
    }
  ];
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed text-sm">
                           <li>La température de l'huile est critique : trop froide, les churros seront gras ; trop chaude, ils seront crus à l'intérieur.</li>
                           <li>Utilisez une poche à douille solide (en toile) ou une presse à churros. La pâte est très compacte et peut faire éclater les poches jetables standards.</li>
                           <li>Servez immédiatement avec une sauce chocolat épaisse pour la trempette.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic text-sm">
                          "Attention sécurité ! Utilisez impérativement une douille cannelée (étoile). Si vous utilisez une douille ronde pour faire des boudins lisses, la pâte risque d'exploser dans la friture car la vapeur ne pourra pas s'échapper correctement par les stries."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
