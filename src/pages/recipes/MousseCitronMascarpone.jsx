...
const MousseCitronMascarpone = () => {
  ...
  const steps = [
    { title: "PRÉPARATION", text: "Séparer les blancs des jaunes d'oeufs. Zester et presser les citrons." },
    { title: "MÉLANGE", text: "Fouetter les jaunes avec le sucre jusqu'à blanchiment. Ajouter le mascarpone, le jus et le zeste de citron." },
    { title: "MONTAGE", text: "Monter les blancs en neige ferme avec une pincée de sel." },
    { title: "FINITION", text: "Incorporer délicatement les blancs à la crème au mascarpone à l'aide d'une maryse." },
    { title: "REPOS", text: "Répartir dans des verrines et réfrigérer au moins 4h." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Assurez-vous que le mascarpone est bien froid pour une meilleure tenue.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Remplacez le citron jaune par du citron vert pour une note plus exotique.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
