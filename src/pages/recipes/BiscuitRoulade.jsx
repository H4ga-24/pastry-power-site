...
const BiscuitRoulade = () => {
  const baseServings = 2;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit roulade",
    prepTime: "20 MIN",
    cookTime: "12 MIN",
    difficulty: "FACILE",
    description: "Le biscuit roulade est un biscuit souple et aérien, parfait pour réaliser des bûches ou des gâteaux roulés traditionnels. Sa texture permet de le rouler sans qu'il ne casse.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2021/07/biscuit-roulade.jpg",
  };

  const ingredients = [
    { name: 'Oeufs', amount: 200, unit: 'g' },
    { name: 'Sucre moyenne', amount: 200, unit: 'g' },
    { name: 'Jaunes d\'oeufs', amount: 80, unit: 'g' },
    { name: 'Blancs d\'oeuf', amount: 120, unit: 'g' },
    { name: 'Sucre semoule', amount: 20, unit: 'g' },
    { name: 'Farine type 55', amount: 100, unit: 'g' },
    { name: 'Poids obtenu', amount: 720, unit: 'g' }
  ];

  const steps = [
    {
      title: "PRÉPARATION.",
      text: "Préparer le matériel et les ingrédients."
    },
    {
      title: "APPAREIL.",
      text: "Mélanger dans une cuve de batteur, les œufs, les jaunes d'œufs avec la première partie du sucre semoule à l'aide du fouet."
    },
    {
      title: "CHAUFFER.",
      text: "Chauffer sur feu doux jusqu'à 50°C maximum, sans cesser de battre et en tournant la cuve."
    },
    {
      title: "RUBAN.",
      text: "Monter en vitesse moyenne jusqu'au doublement de la masse. Monter en grande vitesse à la fin du montage, 2 minutes jusqu'au RUBAN."
    },
    {
      title: "DÉBARRASSER.",
      text: "Débarrasser dans une bassine assez grande."
    },
    {
      title: "MERINGUE.",
      text: "Monter les blancs d'œufs et SERRER avec la deuxième partie du sucre semoule."
    },
    {
      title: "TAMISER.",
      text: "Tamiser la farine sur une feuille de papier."
    },
    {
      title: "MÉLANGE.",
      text: "Incorporer en pluie délicatement la farine tamisée à l'aide d'une écumoire ou d'une Maryse dans le mélange œufs, jaunes d'œufs et sucre."
    },
    {
      title: "INCORPORATION.",
      text: "Incorporer délicatement les blancs montés dans la masse jaunes œufs sucre."
    },
    {
      title: "DRESSAGE.",
      text: "Étaler le biscuit roulade sur une plaque avec feuille de cuisson graissée."
    },
    {
      title: "CUISSON.",
      text: "Cuire dans un four vif ventilé de préférence à 240°C sans buée pendant 6 minutes. Le biscuit doit être blond sur toute sa surface."
    },
    {
      title: "FINITION.",
        ...
        <div className="container mx-auto px-4 max-w-6xl pb-24">
          ...
          <div className="flex gap-4 mb-16 max-w-4xl ml-auto">
            ...
            <p className="text-gray-300 font-light text-lg italic leading-relaxed pt-4">
              Deux doses = Une feuille de 40 sur 60 cm.
            </p>
          </div>
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Doses</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Souplesse</h4>
                      <p className="text-gray-400 font-light leading-relaxed">
                        La particularité de ce biscuit est de rester très souple après cuisson, ce qui permet de le rouler sans qu'il ne se brise. Il est donc important de ne pas le surcuire.
                      </p>
                    </TabsContent>
                    
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Roulage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">
                        Pour faciliter le roulage, vous pouvez retourner le biscuit chaud sur un torchon humide ou une feuille de cuisson propre, et le rouler immédiatement.
                      </p>
                    </TabsContent>
                  </div>
                </Tabs>
