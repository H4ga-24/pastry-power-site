...
const BiscuitViennoisCacao = () => {
  const baseServings = 1;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit viennois au cacao",
    prepTime: "20 MIN",
    cookTime: "15 MIN",
    difficulty: "FACILE",
    description: "Plongez dans l'exquise légèreté du biscuit viennois au cacao, où chaque bouchée révèle une texture fondante et aérienne. Avec la délicatesse de la poudre d'amandes et l'intensité d'un cacao extra rouge.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2024/09/biscuit-viennois.png",
  };

  const ingredients = [
    { name: 'Poudre d\'amande', amount: 100, unit: 'g' },
    { name: 'Sucre semoule', amount: 100, unit: 'g' },
    { name: 'Jaunes d\'oeufs', amount: 47, unit: 'g' },
    { name: 'Oeufs', amount: 83, unit: 'g' },
    { name: 'Blancs d\'oeuf', amount: 180, unit: 'g' },
    { name: 'Sucre semoule (pour blancs)', amount: 42, unit: 'g' },
    { name: 'Farine type 55', amount: 47, unit: 'g' },
    { name: 'Cacao poudre', amount: 33, unit: 'g' },
    { name: 'Masse obtenue totale', amount: 632, unit: 'g' }
  ];

  const steps = [
    {
      title: "BLANCHIR LES OEUFS ET AMANDES.",
      text: "Au batteur, à la feuille, blanchir la poudre d'amandes, le sucre (100g), les oeufs entiers et les jaunes d'oeuf."
    },
    {
      title: "MONTER LES BLANCS.",
      text: "Incorporer les blancs montés dans le premier appareil blanchi (avec les 42g de sucre)."
    },
    {
      title: "AJOUTER LA FARINE ET LE CACAO.",
      text: "Finir en ajoutant délicatement la farine préalablement tamisée et le cacao en poudre."
    },
    {
      title: "ÉTALER SUR PLAQUE.",
      text: "Dresser la masse sur 600 g et lisser à l'aide d'une spatule."
    },
    {
      title: "CUISSON.",
      text: "Faire cuire au four ventilé à 180°C pendant environ 7 minutes."
    }
  ];
      ...
      <div className="min-h-screen bg-[#121212] text-white font-sans pt-20">
        ...
        <div className="container mx-auto px-4 max-w-6xl pb-24">
          <div className="flex gap-4 mb-16 max-w-4xl ml-auto">
            ...
            <p className="text-gray-300 font-light text-lg italic leading-relaxed pt-4">L'harmonie parfaite entre finesse et gourmandise.</p>
          </div>
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Recette (632g)</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">L'utilisation d'un cacao de haute qualité (type Extra Rouge ou Plein Arôme) fera toute la différence gustative et visuelle pour ce biscuit.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Technique</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ce biscuit est fragile et très moelleux. Il est parfait pour réaliser des bûches roulées car il supporte bien d'être roulé sans casser.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitViennoisCacao;