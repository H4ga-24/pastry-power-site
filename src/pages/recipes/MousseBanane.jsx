...
const MousseBanane = () => {
  ...
  const steps = [
    { title: "MIXAGE", text: "Mixer les bananes avec le jus de citron (très important pour éviter qu'elles noircissent) et le sucre." },
    { title: "GÉLATINE", text: "Réhydrater la gélatine. Chauffer une petite partie de la purée de banane, y fondre la gélatine essorée." },
    { title: "MÉLANGE", text: "Mélanger avec le reste de la purée froide." },
    { title: "MONTAGE", text: "Monter la crème en chantilly et l'incorporer délicatement à la purée de banane." },
    { title: "REPOS", text: "Réserver au frais au moins 4 heures." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Cette mousse se marie parfaitement avec le chocolat noir ou le caramel.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Maturité</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez des bananes tigrées pour un goût optimal.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
