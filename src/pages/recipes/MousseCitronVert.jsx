...
const MousseCitronVert = () => {
  ...
  const ingredients = [
    ...
    { name: 'Jaunes d\'oeufs (pour la base)', amount: 3, unit: 'pièces' }
  ];

  const steps = [
    { title: "CRÈME CITRON", text: "Cuire le jus, les zestes, le sucre et les jaunes comme une crème pâtissière (85°C) pour faire une base." },
    { title: "COLLAGE", text: "Ajouter la gélatine réhydratée dans la crème chaude. Bien mélanger." },
    { title: "REFROIDISSEMENT", text: "Laisser refroidir la base citron jusqu'à 30°C." },
    { title: "MONTAGE", text: "Monter la crème liquide en chantilly souple." },
    { title: "INCORPORATION", text: "Incorporer délicatement la chantilly à la base citron." },
    { title: "REPOS", text: "Laisser prendre au froid pendant 4h minimum." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Infusez des feuilles de basilic ou de menthe dans le jus de citron pour une touche originale.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Meringue</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez aussi faire cette mousse sur une base de meringue italienne au citron pour plus de légèreté.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
