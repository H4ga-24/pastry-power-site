...
const LaPateAPain = () => {
  const baseServings = 3; // 3 baguettes ou 1 gros pain
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "BOULANGERIE • BASES",
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">La vapeur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le coup de buée est essentiel : l'humidité retarde la formation de la croûte, permettant au pain de bien gonfler, et rend ensuite la croûte fine et brillante.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Autolyse</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ne sautez pas l'autolyse si possible. Ce repos eau+farine facilite le pétrissage et améliore la structure de la mie.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
