...
const MousseChocolatBlancOeuf = () => {
  ...
  const steps = [
    ...
    { title: "JAUNES", text: "Incorporer les jaunes d'œufs un par un dans le chocolat fondu tiède." },
    { title: "BLANCS", text: "Monter les blancs en neige ferme avec une pincée de sel (et le sucre si désiré)." },
    { title: "MÉLANGE", text: "Incorporer 1/3 des blancs vigoureusement pour détendre le chocolat, puis incorporer le reste délicatement à la maryse." },
    { title: "REPOS", text: "Réserver au frais au moins 4 heures avant de servir." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 6 personnes</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez des œufs extra frais et à température ambiante.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ajoutez quelques zestes d'orange ou une goutte de café dans le chocolat fondu.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
