                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-gray-400 leading-relaxed text-sm">
                           <li>Aromatisez le sirop du fondant avec un peu de Kirsch pour rappeler la garniture et parfumer le glaçage.</li>
                           <li>Le chocolat vermicelle doit être appliqué immédiatement après le trempage dans le fondant, avant qu'il ne fige complètement.</li>
                           <li>Si vous n'aimez pas le Kirsch, le Salambo peut aussi se faire au Grand Marnier (glaçage rose) ou au Rhum.</li>
                        </ul>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed italic text-sm">
                          "Le Salambo est un classique un peu oublié qui mérite sa place en vitrine. L'alliance Kirsch et crème pâtissière est un marqueur fort de la pâtisserie traditionnelle française."
                        </p>
                      </div>
                    </div>
                  </TabsContent>
