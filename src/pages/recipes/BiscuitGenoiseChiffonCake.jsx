...
const BiscuitGenoiseChiffonCake = () => {
  const baseServings = 6;
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • BISCUITS",
    title: "Biscuit génoise chiffon cake",
    prepTime: "30 MIN",
    cookTime: "35 MIN",
    difficulty: "MOYEN",
    description: "Ce biscuit est extrêmement léger, moelleux et très aérien. Il ne s'affaisse pas après la cuisson.",
    image: "https://www.tendances-food.fr/wp-content/uploads/2022/02/orange-chiffon-cake-whole-featured-1.jpg",
  };

  const ingredients = [
    { name: 'Farine T55', amount: 85, unit: 'g' },
    { name: 'Farine amande', amount: 85, unit: 'g' },
    { name: 'Sucre', amount: 100, unit: 'g' },
    { name: 'Oeufs', amount: 5, unit: 'pcs' },
    { name: 'Levure chimique', amount: 1, unit: 'sachet' },
    { name: 'Huile neutre', amount: 75, unit: 'ml' },
  ...
  const steps = [
    {
      title: "POUDRES.",
      text: "Mélanger les farines et la levure."
    },
    {
      title: "BLANCHIR.",
    ...
    {
      title: "HUILE.",
      text: "Incorporer l'huile."
    },
    {
      title: "FARINES.",
      text: "Ajouter les farines."
    },
    {
      title: "BLANCS.",
    ...
    {
      title: "MÉLANGE.",
      text: "Incorporer délicatement les blancs."
    },
    {
      title: "CUISSON.",
      text: "Cuire 35 min à 180°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Utiliser des oeufs à température ambiante pour une meilleure incorporation.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Ne pas graisser le moule permet au gâteau de "grimper" sur les parois.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Une texture nuageuse incomparable.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
...
export default BiscuitGenoiseChiffonCake;