             ...
             <div className="mt-8 p-4 bg-[#1a1a1a] border-l-2 border-[#D4AF37] rounded-r-sm">
                <div className="flex items-start gap-3">
                   ...
                   <div>
                      ...
                      <p className="text-gray-400 text-xs">Moule polycarbonate forme triangle ou tablette classique. La filtration de la purée de fraise est cruciale pour une texture soyeuse.</p>
                   </div>
                </div>
             </div>
          </div>
           ...
           <div className="space-y-12">
              ...
              <div className="space-y-10">
                 ...
                 <div className="relative pl-8 border-l border-[#D4AF37]/20">
                    ...
                    <h4 className="text-xl text-white mb-4 font-serif">Préparation de la ganache fraise</h4>
                    <p className="text-gray-400 leading-relaxed mb-4">
                       Porter la crème liquide à ébullition. Verser la crème chaude sur la couverture lait partiellement fondue.
                    </p>
                    <p className="text-gray-400 leading-relaxed">
                       Ajouter le beurre en dés et les fraises préalablement mixées et passées au chinois étamine (pour retirer les akènes).
                       Mixer l'ensemble au mixeur plongeant sans incorporer d'air, puis chinoiser une nouvelle fois si nécessaire pour garantir une texture parfaitement lisse.
                 ...
                 <div className="relative pl-8 border-l border-[#D4AF37]/20">
                    ...
                    <p className="text-gray-400 leading-relaxed mb-4">
                       Mettre au point la couverture lait. Remplir les moules à tablettes à ras bord.
                    ...
                    <p className="text-gray-400 leading-relaxed mb-4">
                       Garnir les coques avec la ganache fraise (à bonne température) en laissant 2mm pour l'obturation.
                       Laisser figer au frais pendant 2 heures (la ganache doit former une peau suffisamment résistante).
                    </p>
                    <p className="text-gray-400 leading-relaxed">
                       Obturer les tablettes avec de la couverture lait tempérée. Lisser soigneusement à la spatule.
                       Laisser cristalliser complètement (environ 2h) avant de procéder au démoulage délicat.
                    </p>
                 </div>
              </div>
              ...
              <div className="mt-16 p-8 bg-[#1a1a1a] border border-[#D4AF37]/20 rounded-sm relative overflow-hidden">
                 ...
                 <div className="grid md:grid-cols-2 gap-8 text-gray-400 text-sm leading-relaxed">
                    <p>
                       <strong className="text-white block mb-2">Filtration Soignée :</strong> Ne négligez pas l'étape du chinoisage pour les fraises. Les petits grains (akènes) peuvent obstruer la poche à douille et être désagréables en bouche dans une ganache fine.
                    </p>
                    <p>
                       <strong className="text-white block mb-2">Température de Ganache :</strong> Pour le chocolat au lait, attention à ne pas couler une ganache trop chaude. Elle risquerait de faire fondre votre coque plus facilement qu'avec du chocolat noir.
                    </p>
                    <p>
                       <strong className="text-white block mb-2">Moulage fin :</strong> Une coque trop épaisse rendra la dégustation écœurante. Le chocolat au lait étant plus sucré, la finesse de la coque est essentielle pour l'équilibre avec le fruit.
                    </p>
                    <p>
                       <strong className="text-white block mb-2">Cristallisation :</strong> Le chocolat au lait met un peu plus de temps à cristalliser que le noir. Soyez patient avant de démouler pour éviter les traces blanches ou la casse.
                    </p>
                    <p>
                       <strong className="text-white block mb-2">Obturation :</strong> Assurez-vous que la ganache a bien croûté avant de refermer. Si elle est trop molle, elle se mélangera au chocolat de couverture et créera des défauts visuels.
                    </p>
                    <p>
                       <strong className="text-white block mb-2">Conservation :</strong> Les ganaches aux fruits frais sont plus humides. Ces tablettes se conservent idéalement à 16-18°C et doivent être consommées plus rapidement que des pralinés.
                    </p>
                 </div>
              </div>
