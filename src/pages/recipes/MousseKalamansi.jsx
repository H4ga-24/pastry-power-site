...
const MousseKalamansi = () => {
  ...
  const steps = [
    ...
    { title: "CHAUFFE", text: "Chauffer une petite partie de la purée avec le sucre." },
    { title: "COLLAGE", text: "Ajouter la gélatine essorée. Mélanger avec le reste de purée pour refroidir." },
    { title: "MONTAGE", text: "Monter la crème en chantilly." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème à la base kalamansi." },
    { title: "FINITION", text: "Dresser aussitôt." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Puissance</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le kalamansi a un goût très concentré, n'hésitez pas à goûter votre base avant d'incorporer la crème.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Alternatives</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Peut être remplacé par un mélange jus de citron vert / mandarine.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
