...
const InsertCompoteeAbricotPassion = () => {
  ...
  const steps = [
    { title: "DÉCOUPE", text: "Couper les abricots en petits dés réguliers." },
    { title: "CUISSON", text: "Dans une casserole, compoter les dés d'abricots avec la purée de passion et la vanille à feu moyen." },
    { title: "PECTINE", text: "Mélanger le sucre et la pectine. Verser en pluie sur les fruits chauds en remuant." },
    { title: "ÉBULLITION", text: "Porter à ébullition pendant 1 minute pour activer la pectine." },
    { title: "COULAGE", text: "Couler dans l'insert et laisser refroidir avant de congeler." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Romarin</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Infuser une branche de romarin frais pendant la cuisson des abricots apporte une touche herbacée originale.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Pectine</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si vous n'avez pas de pectine NH, utilisez du sucre gélifiant type confiture.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
