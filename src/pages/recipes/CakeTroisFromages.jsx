...
const CakeTroisFromages = () => {
  const ingredients = [
    ...
    { name: "Bleu d'Auvergne", amount: "100g" },
    { name: "Mimolette", amount: "100g" },
    { name: "Poivre", amount: "2 pincées" }
  ];

  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake 3 Fromages - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake 3 Fromages" src="https://www.ramenelapopotte.com/sites/default/files/cake_courgette_3_fromages_coupe_zoom.jpg" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake aux 3 Fromages</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Coupez le Bleu d'Auvergne et la Mimolette en dés.</p>
              ...
              <p><span className="text-[#D4AF37] font-bold">3.</span> Ajoutez les œufs, l'huile et le lait. Mélangez pour obtenir une pâte lisse.</p>
              <p><span className="text-[#D4AF37] font-bold">4.</span> Incorporez les trois fromages (gruyère, bleu, mimolette). Poivrez généreusement. Ne salez pas.</p>
