...
const CremeuxCaramel = () => {
  ...
  const recipeData = {
    ...
    cookTime: "15 MIN",
    difficulty: "MOYEN",
    description: "La gourmandise à l'état pur. Un caramel cuit à sec, déglacé à la crème et enrichi de jaunes d'œufs pour une texture fondante et réconfortante.",
  ...
  const steps = [
    { title: "Préparation", text: "Hydrater la gélatine. Chauffer la crème liquide (sans bouillir)." },
    { title: "Caramel", text: "Réaliser un caramel à sec avec le sucre dans une casserole, jusqu'à obtenir une belle couleur ambrée." },
    { title: "Décuisson", text: "Déglacer le caramel en versant la crème chaude petit à petit (attention aux projections), en remuant vivement." },
    { title: "Cuisson", text: "Verser ce caramel liquide sur les jaunes d'œufs battus, remettre le tout dans la casserole et cuire à la nappe (84°C) comme une crème anglaise." },
    { title: "Finition", text: "Hors du feu, ajouter la gélatine et la fleur de sel. Mixer et laisser refroidir." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Cuisson du sucre</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Poussez bien la cuisson du caramel. S'il est trop clair, le goût sera juste sucré sans la complexité aromatique du caramel. Ne le brûlez pas non plus (amertume).</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Beurre</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour encore plus de gourmandise, vous pouvez monter le crémeux avec 30g de beurre doux en fin de préparation.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
