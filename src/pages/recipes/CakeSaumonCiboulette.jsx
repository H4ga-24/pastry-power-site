...
const CakeSaumonCiboulette = () => {
  const ingredients = [
    ...
    { name: "Saumon fumé", amount: "200g" },
    { name: "Ciboulette", amount: "10 brins" },
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake Saumon Fumé Ciboulette - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake Saumon Ciboulette" src="https://i0.wp.com/unepausehealthyf.com/wp-content/uploads/2021/04/cake-sale%CC%81-saumon-fume%CC%81-scaled.jpeg" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake Saumon Fumé</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Coupez le saumon fumé en lanières ou en dés. Ciselez finement la ciboulette.</p>
              ...
              <p><span className="text-[#D4AF37] font-bold">4.</span> Ajoutez le gruyère râpé, le saumon et la ciboulette. Salez peu (à cause du saumon) et poivrez.</p>
