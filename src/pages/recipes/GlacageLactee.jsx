...
const GlacageLactee = () => {
  ...
  const steps = [
    ...
    {
      title: "VERSER.",
      text: "Verser le sirop bouillant sur le chocolat au lait (préalablement fondu ou en pistoles) et le lait concentré dans un pichet."
    },
    {
      title: "INCORPORATION.",
      text: "Ajouter la masse gélatine fondue. Laisser reposer une minute."
    },
    {
      title: "EMULSION.",
      text: "Mixer au mixeur plongeant sans incorporer de bulles d'air. Filmer au contact et réserver 24h. Utiliser à 30-35°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Qualité du chocolat</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez un chocolat de couverture de qualité (type Jivara ou Tanariva) pour une fluidité optimale et un goût incomparable.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
