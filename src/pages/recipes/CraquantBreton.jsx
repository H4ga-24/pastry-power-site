...
const CraquantBreton = () => {
  ...
  const recipeData = {
    ...
    cookTime: "12 MIN",
    difficulty: "FACILE",
    description: "Une spécialité bretonne légère, très fine et extrêmement croustillante, aux éclats de noisettes ou d'amandes.",
  ...
  const steps = [
    { title: "MÉLANGE", text: "Mélanger le sucre, la farine et les noisettes hachées." },
    { title: "LIANT", text: "Ajouter les blancs d'œufs non battus et la vanille. Mélanger pour obtenir une pâte homogène." },
    { title: "DRESSAGE", text: "Déposer des petits tas équivalents à une cuillère à café sur une plaque beurrée ou un tapis silicone, très espacés." },
    { title: "CUISSON", text: "Cuire à 180°C pendant 10 à 12 minutes. Les biscuits vont s'étaler et caraméliser." },
    { title: "REFROIDISSEMENT", text: "Laisser refroidir sur une surface plane pour qu'ils durcissent." }
  ];
