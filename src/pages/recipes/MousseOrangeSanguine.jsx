                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Saison</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Profitez de la saison courte (janvier-mars) pour réaliser cette mousse avec des fruits frais.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Formidable en duo avec une mousse chocolat blanc ou un biscuit pistache.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
