...
const MousseRhubarbe = () => {
  ...
  const recipeData = {
    ...
    cookTime: "15 MIN",
    difficulty: "MOYEN",
    description: "Une mousse acidulée et originale, à la couleur rosée si la rhubarbe n'est pas trop épluchée.",
    image: "https://img.cuisineaz.com/660x495/2019/06/06/i147513-mousse-de-rhubarbe-au-thermomix.jpeg",
  };

  const ingredients = [
    { name: 'Compote de rhubarbe', amount: 300, unit: 'g' },
  ...
  const steps = [
    { title: "GÉLATINE", text: "Réhydrater la gélatine." },
    { title: "PRÉPARATION", text: "Si vous partez de tiges fraîches, coupez-les en tronçons, cuisez-les avec un peu de sucre jusqu'à compotée. Mixez finement." },
    { title: "CHAUFFE", text: "Chauffer une partie de la compote." },
    { title: "COLLAGE", text: "Incorporer la gélatine essorée. Mélanger avec le reste de compote froide." },
    { title: "MONTAGE", text: "Monter la crème en chantilly." },
    { title: "MÉLANGE", text: "Incorporer délicatement la crème à la compote gélifiée." },
    { title: "FINITION", text: "Dresser." }
  ];
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pour 1 cercle (20cm)</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Couleur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">N'épluchez pas complètement la rhubarbe pour conserver sa jolie couleur rose/verte.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Duo</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La fraise est la meilleure amie de la rhubarbe.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
