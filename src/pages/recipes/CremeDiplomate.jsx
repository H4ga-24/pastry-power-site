...
const CremeDiplomate = () => {
  const baseServings = 600; // grams
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • CRÈMES",
    title: "La crème diplomate",
    prepTime: "30 MIN + Repos",
    cookTime: "10 MIN",
    difficulty: "MOYEN",
  ...
  const steps = [
    {
      ...
      text: "Réaliser une crème pâtissière : Infuser la vanille dans le lait chaud. Blanchir jaunes et sucre, ajouter maïzena. Verser le lait dessus, cuire à la casserole jusqu'à épaississement."
    },
    {
      title: "COLLAGE.",
      text: "Hors du feu, ajouter la gélatine préalablement hydratée et essorée, ainsi que le beurre. Mélanger jusqu'à dissolution complète."
    },
    {
      title: "REFROIDISSEMENT.",
      text: "Débarrasser la crème sur une plaque, filmer au contact et mettre au froid. Elle doit descendre en température mais ne pas être totalement figée (environ 25°C)."
    },
    {
      title: "LISSAGE.",
      text: "Une fois la pâtissière refroidie, la fouetter vigoureusement pour la détendre et la lisser."
    },
    {
      title: "MONTAGE.",
      text: "Monter la crème liquide froide en chantilly souple (baveuse). Incorporer délicatement un tiers de la chantilly à la pâtissière au fouet pour détendre, puis le reste à la maryse."
    },
    {
      title: "UTILISATION.",
      text: "Utiliser immédiatement (pochage ou garnissage) avant que la gélatine ne prenne définitivement."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si la pâtissière est trop froide (bloc), la lisser au fouet avant d'incorporer la crème montée. Si elle est trop chaude, elle fera retomber la chantilly.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Chantilly</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Montez la crème "baveuse" (souple). Si elle est trop ferme (en grain), elle s'incorporera mal et vous aurez des grains de gras dans la diplomate.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
