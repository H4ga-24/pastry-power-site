...
const GlacageNoir = () => {
  ...
  const steps = [
    ...
    {
      title: "CACAO.",
      text: "Ajouter le cacao en poudre tamisé dans le sirop. Bien mélanger au fouet (attention aux grumeaux)."
    },
    {
      title: "CRÈME.",
      text: "Ajouter la crème liquide tiède. Reporter à ébullition quelques secondes pour lisser le mélange."
    },
    {
      title: "FINITION.",
      text: "Retirer du feu. Ajouter la gélatine essorée. Mixer longuement au mixeur plongeant sans incorporer d'air. Chinoiser et laisser reposer 24h. Utiliser à 30-32°C."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Bulles d'air</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le cacao a tendance à emprisonner beaucoup d'air. Soyez très minutieux lors du mixage, en gardant la tête du mixeur toujours immergée et inclinée pour laisser échapper les bulles.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
