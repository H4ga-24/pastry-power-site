...
const CremeuxFramboise = () => {
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "La pureté du fruit dans une crème onctueuse. Ce crémeux framboise offre une couleur vibrante et un goût intense, parfait pour équilibrer des desserts sucrés.",
  ...
  const steps = [
    ...
    { title: "Cuisson", text: "Chauffer la purée de framboise. Fouetter légèrement les œufs, jaunes et sucre. Verser la purée chaude dessus et cuire à la nappe (83°C)." },
    { title: "Collage", text: "Ajouter la gélatine essorée hors du feu. Chinoiser pour retirer les éventuels grains cuits." },
    { title: "Emulsion", text: "Laisser tiédir à 40°C, puis ajouter le beurre froid en dés. Mixer au mixeur plongeant pour lisser parfaitement." },
    { title: "Repos", text: "Réserver au froid au moins 4 heures pour cristallisation." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Si vos framboises sont très acides, vous pouvez ajuster légèrement la quantité de sucre jusqu'à 70g.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Association</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Ce crémeux se marie divinement avec le chocolat noir, la pistache ou la vanille.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
