...
const CakeTomateMozza = () => {
  const ingredients = [
    ...
    { name: "Basilic (feuilles)", amount: "2" },
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake Tomate Mozzarella Basilic - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake Tomate Mozzarella" src="https://cuisinedaubery.com/wp-content/uploads/2024/03/cake-italien_ALTERN09.jpg" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake Tomate, Mozzarella & Basilic</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Coupez les tomates en dés (épépinez-les si elles sont très juteuses) et la mozzarella en cubes. Ciselez le basilic.</p>
              <p><span className="text-[#D4AF37] font-bold">2.</span> Préchauffez le four à 180°C. Dans un saladier, mélangez la farine et la levure chimique.</p>
              <p><span className="text-[#D4AF37] font-bold">3.</span> Ajoutez les œufs, l'huile d'olive, l'huile neutre et le lait tiédi. Mélangez jusqu'à obtenir une pâte homogène.</p>
              <p><span className="text-[#D4AF37] font-bold">4.</span> Incorporez le gruyère râpé, les dés de tomates, la mozzarella et le basilic. Assaisonnez.</p>
              <p><span className="text-[#D4AF37] font-bold">5.</span> Versez dans un moule à cake chemisé ou huilé. Enfournez pour environ 45 minutes.</p>
            </div>
          </div>
        </div>
      </div>
