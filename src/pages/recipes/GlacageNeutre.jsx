...
const GlacageNeutre = () => {
  ...
  const steps = [
    {
      title: "MÉLANGE SEC.",
      text: "Dans un petit bol, mélanger intimement le sucre (une partie, environ 50g) avec la pectine NH. Cela évite les grumeaux."
    },
    {
      title: "CHAUFFE.",
    ...
    {
      title: "PECTINE.",
      text: "Ajouter le mélange sucre/pectine en pluie tout en fouettant vigoureusement."
    },
    {
      title: "ÉBULLITION.",
      text: "Porter à ébullition et maintenir l'ébullition pendant au moins 1 minute pour activer la pectine. Ajouter le jus de citron."
    },
    {
      title: "STOCKAGE.",
      text: "Débarrasser et filmer au contact. Conserver au frais. Ce nappage se liquéfie en le chauffant légèrement avant utilisation."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Application</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Appliquez le nappage neutre au pinceau sur vos tartes aux fruits pour les faire briller et empêcher les fruits de sécher.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
