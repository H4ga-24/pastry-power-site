                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Proportions</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La règle de base classique est "tant pour tant" pour la moitié : 500g farine pour 250g beurre. L'eau est ajustée au jugement.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Croquant</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour imperméabiliser le fond de tarte et garder le croustillant avec une garniture liquide, badigeonnez le fond de blanc d'œuf cru 5 minutes avant la fin de la cuisson à blanc.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
