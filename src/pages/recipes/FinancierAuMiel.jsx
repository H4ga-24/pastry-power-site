...
const FinancierAuMiel = () => {
  ...
  const steps = [
    { title: "BEURRE NOISETTE", text: "Réaliser un beurre noisette dans une casserole, puis laisser tiédir." },
    { title: "MÉLANGE SEC", text: "Dans un bol, mélanger la poudre d'amande, le sucre glace et la farine tamisée." },
    { title: "LIQUIDES", text: "Ajouter les blancs d'œufs non montés, puis le miel liquide." },
    { title: "FINITION", text: "Incorporer le beurre noisette filtré." },
    { title: "CUISSON", text: "Verser dans des moules et cuire à 180°C pendant 12 à 15 minutes." }
  ];
