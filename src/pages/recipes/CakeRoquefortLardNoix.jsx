...
const CakeRoquefortLardNoix = () => {
  const ingredients = [
    ...
    { name: "Huile", amount: "30g" },
    { name: "Huile de noix", amount: "50g" },
    { name: "Lait", amount: "125g" },
    { name: "Gruyère", amount: "100g" },
    { name: "Roquefort", amount: "150g" },
    { name: "Noix", amount: "30g" },
    { name: "Lard", amount: "50g" },
    { name: "Huile (pour lard)", amount: "10g" },
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white font-sans pt-32 pb-20">
      <Helmet><title>Cake Roquefort Lard Noix - Maison Dorée</title></Helmet>
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img className="w-full h-96 object-cover rounded-sm mb-8" alt="Cake Roquefort Lard Noix" src="https://lespapillesdekaren.com/wp-content/uploads/2025/04/wp_a5af49_cake-au-roquefort-et-aux-noix.JPG" />
            <h1 className="text-4xl font-serif mb-6 text-white">Cake Roquefort, Lard & Noix</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p><span className="text-[#D4AF37] font-bold">1.</span> Coupez le lard en lardons et faites-les revenir dans 10g d'huile. Émiettez le roquefort et concassez les noix.</p>
              <p><span className="text-[#D4AF37] font-bold">2.</span> Préchauffez le four à 180°C. Dans un bol, mélangez la farine et la levure.</p>
              <p><span className="text-[#D4AF37] font-bold">3.</span> Ajoutez les œufs, l'huile (30g), l'huile de noix (50g) et le lait. Mélangez bien.</p>
              <p><span className="text-[#D4AF37] font-bold">4.</span> Incorporez le gruyère, le roquefort, les lardons et les noix. Salez légèrement et poivrez.</p>
