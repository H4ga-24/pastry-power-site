...
const MousseMirabelle = () => {
  ...
  const steps = [
    ...
    { title: "COLLAGE", text: "Ajouter la gélatine essorée. Mélanger avec le reste de purée et l'eau de vie." },
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Caractère</h4>
                      <p className="text-gray-400 font-light leading-relaxed">L'eau de vie est indispensable pour retrouver le "vrai" goût du fruit cuisiné.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Insert</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Une compotée de mirabelles au centre apportera de la texture.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
