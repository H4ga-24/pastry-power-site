  ...
  const steps = [
    {
      ...
      text: "Réaliser une crème anglaise : chauffer le lait avec la vanille. Verser sur les jaunes blanchis avec le sucre. Cuire à la nappe (83°C) sans faire bouillir."
    },
    {
      title: "COLLAGE.",
      text: "Hors du feu, ajouter la gélatine préalablement hydratée et essorée. Bien mélanger pour dissoudre."
    },
    {
      title: "REFROIDISSEMENT.",
      text: "Débarrasser dans un cul de poule. Faire refroidir le mélange jusqu'à environ 25°C-30°C. La crème doit commencer à épaissir légèrement mais rester liquide."
    },
    {
      title: "CRÈME FOUETTÉE.",
      text: "Monter la crème liquide bien froide en chantilly mousseuse (pas trop ferme)."
    },
    {
      title: "MÉLANGE.",
      text: "Incorporer délicatement la crème fouettée à l'anglaise refroidie à l'aide d'une maryse, en soulevant la masse."
    },
    {
      title: "MOULAGE.",
      text: "Couler immédiatement dans le moule ou l'entremets et faire prendre au froid (réfrigérateur ou congélateur)."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Timing</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Le moment crucial est le mélange : si l'anglaise est trop chaude, la chantilly fond. Si elle est trop froide (gélifiée), vous aurez des grumeaux. Visez 25°C-30°C.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">C'est une base neutre. Vous pouvez l'aromatiser au chocolat, aux fruits (purée de fruits à la place du lait), ou aux alcools.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
