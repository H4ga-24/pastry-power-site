...
const MousseGoyave = () => {
  ...
  const steps = [
    ...
    { title: "PRÉPARATION", text: "Chauffer une partie de la purée de goyave avec le sucre." },
    { title: "INCORPORATION", text: "Ajouter la gélatine essorée. Mélanger avec le reste de purée et le citron vert." },
    { title: "MONTAGE", text: "Monter la crème en chantilly souple." },
    { title: "FINALISATION", text: "Incorporer délicatement la chantilly à la purée de goyave refroidie." },
    { title: "DRESSAGE", text: "Verser dans les moules." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Douceur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">La goyave est douce, n'hésitez pas à l'associer à une pointe de citron vert.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La purée de goyave est souvent épaisse, attention à bien mélanger la gélatine.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
