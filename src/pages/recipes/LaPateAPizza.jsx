...
const LaPateAPizza = () => {
  const baseServings = 4; // 4 Pizzas
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "BOULANGERIE • PÂTES",
               ...
               <div className="sticky top-24">
                 <div className="bg-[#1a1a1a] border-t-2 border-[#D4AF37] p-6 mb-8">
                   ...
                   <div className="flex items-center justify-between bg-[#121212] p-3 rounded mb-6">
                     <span className="text-sm text-gray-400">Pizzas</span>
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Fermentation longue</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour plus de goût et de digestibilité, réduisez la levure de moitié et laissez fermenter la pâte 24h à 48h au réfrigérateur.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Farine T00</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si possible, utilisez de la farine italienne type "00" riche en gluten, spécialement conçue pour supporter les fermentations et l'étirement.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
