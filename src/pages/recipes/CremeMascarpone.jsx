...
const CremeMascarpone = () => {
  const baseServings = 400; // g
  const [servings, setServings] = useState(baseServings);

  const recipeData = {
    category: "PÂTISSERIE • CRÈMES",
    title: "Crème mascarpone",
    prepTime: "10 MIN",
    cookTime: "0 MIN",
    difficulty: "TRÈS FACILE",
    description: "Une crème riche, ferme et veloutée. Parfaite pour le tiramisu, ou comme base de chantilly mascarpone pour garnir des cupcakes.",
  ...
  const steps = [
    {
      title: "DÉTENDRE.",
      text: "Dans le bol du robot, mettre le mascarpone froid et le fouetter légèrement pour le détendre."
    },
    {
      title: "AJOUT.",
    ...
    {
      title: "CONSISTANCE.",
      text: "Continuer de fouetter jusqu'à obtenir une crème montée ferme qui tient bien au fouet."
    },
    {
      title: "ATTENTION.",
      text: "Ne pas trop fouetter une fois la consistance atteinte, car le mascarpone peut grainer et tourner en beurre."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Tenue</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Cette crème a une excellente tenue et peut être utilisée pour décorer un layer cake ou un number cake.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
