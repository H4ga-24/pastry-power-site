...
const CremeBeurreMeringueItalienne = () => {
  const baseServings = 500; // grammes
  ...
  const recipeData = {
    ...
    cookTime: "10 MIN",
    difficulty: "MOYEN",
    description: "La reine des crèmes au beurre : légère, aérienne et parfaitement stable, idéale pour garnir macarons et entremets.",
  ...
  const ingredients = [
    ...
    { name: 'Blancs d\'oeufs', amount: 70, unit: 'g' },
  ...
  const steps = [
    ...
    },
    {
      ...
      text: "Fouetter jusqu'à refroidissement complet de la meringue (environ 30-40°C)."
    },
    {
      title: "EMULSION.",
      text: "Incorporer le beurre pommade petit à petit dans la meringue en fouettant continuellement jusqu'à obtenir une crème lisse et foisonnée."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le beurre doit être pommade (mou) et à la même température que la meringue pour éviter que la crème ne tranche.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
