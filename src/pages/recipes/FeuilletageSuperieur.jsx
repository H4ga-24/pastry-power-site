                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                    <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Maintenir une température constante pendant le laminage pour que le beurre et la détrempe aient la même consistance.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Bien respecter les temps de repos pour un feuilletage optimal et régulier.</p>
                    </TabsContent>
                    <TabsContent value="chef" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">La crème liquide apporte une richesse supplémentaire et une belle coloration à la cuisson.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
