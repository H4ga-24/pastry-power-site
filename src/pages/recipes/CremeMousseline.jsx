...
const CremeMousseline = () => {
  ...
  const ingredients = [
    ...
    { name: 'Beurre doux (dans la crème chaude)', amount: 25, unit: 'g' },
    { name: 'Beurre pommade (au montage)', amount: 100, unit: 'g' },
  ...
  const steps = [
    ...
    {
      title: "PREMIER BEURRE.",
      text: "Hors du feu, incorporer le premier beurre (25g). Filmer au contact et laisser refroidir à température ambiante."
    },
    {
      title: "TEMPÉRATURE.",
      text: "S'assurer que la crème pâtissière et le beurre pommade restant (100g) sont à la même température (environ 20-22°C)."
    },
    {
      title: "FOISONNEMENT.",
    ...
    {
      title: "FINITION.",
      text: "Continuer de fouetter 2 à 3 minutes pour aérer (foisonner) la mousseline. Elle doit blanchir et devenir légère."
    }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Éviter le tranchage</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Si la crème tranche (se sépare), c'est souvent un problème de température. Réchauffez légèrement le bol au bain-marie ou au chalumeau en fouettant énergiquement pour rattraper l'émulsion.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
