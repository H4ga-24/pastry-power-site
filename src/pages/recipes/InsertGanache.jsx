...
const InsertGanache = () => {
  ...
  const steps = [
    { title: "FONTE", text: "Hacher le chocolat finement et le placer dans un bol." },
    { title: "ÉBULLITION", text: "Porter la crème et le miel à ébullition." },
    { title: "EMULSION", text: "Verser la crème chaude sur le chocolat en 3 fois, en créant une émulsion élastique à la maryse." },
    { title: "FINITION", text: "Quand la ganache est à 40°C, ajouter le beurre coupé en dés et lisser." },
    { title: "COULAGE", text: "Couler dans l'insert et congeler immédiatement." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Mixeur</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Pour une ganache parfaitement lisse, utilisez un mixeur plongeant sans incorporer d'air.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Arômes</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Infusez la crème avec de la vanille, des zestes d'agrumes ou des épices pour parfumer l'insert.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
