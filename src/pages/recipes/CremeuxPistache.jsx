...
const CremeuxPistache = () => {
  ...
  const steps = [
    { title: "Préparation", text: "Hydrater la gélatine dans de l'eau froide." },
    { title: "Cuisson", text: "Chauffer le lait et la crème. Fouetter les jaunes avec le sucre sans blanchir. Verser le liquide chaud dessus, reverser dans la casserole et cuire à la nappe (83°C)." },
    { title: "Collage", text: "Hors du feu, ajouter la gélatine essorée et la pâte de pistache. Mélanger." },
    { title: "Emulsion", text: "Mixer au mixeur plongeant pour parfaire l'émulsion et obtenir une texture lisse." },
    { title: "Repos", text: "Couler en moule ou réserver filmé au contact au frais pendant au moins 4h avant utilisation." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Qualité de la pâte</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Utilisez une pâte de pistache 100% pure fruit pour un goût authentique et une couleur naturelle. Évitez les pâtes aromatisées ou colorées artificiellement.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Intensité</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Vous pouvez ajouter une pincée de fleur de sel lors du mixage final pour exhauster le goût de la pistache.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
