...
const CremeuxCafe = () => {
  ...
  const steps = [
    { title: "Infusion", text: "Concasser grossièrement les grains de café. Chauffer le lait et la crème, ajouter le café, couvrir et laisser infuser 20 min. Chinoiser et peser pour réajuster le poids (compléter avec du lait si besoin)." },
    { title: "Cuisson", text: "Chauffer à nouveau le liquide infusé. Fouetter jaunes et sucre. Verser le liquide chaud dessus et cuire à la nappe (83°C)." },
    { title: "Mélange", text: "Hors du feu, ajouter la gélatine hydratée. Verser sur le chocolat au lait haché." },
    { title: "Emulsion", text: "Mixer soigneusement pour obtenir une texture lisse." },
    { title: "Repos", text: "Laisser cristalliser au frais au moins 4 heures." }
  ];
                ...
                <Tabs defaultValue="conseils" className="w-full">
                  ...
                  <div className="p-8">
                     <TabsContent value="conseils" className="m-0">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed">Le chocolat au lait apporte de la texture et une douceur qui balance l'amertume du café. Vous pouvez le remplacer par du chocolat blanc pour un goût plus lacté.</p>
                    </TabsContent>
                    <TabsContent value="astuces" className="m-0">
                      <h4 className="text-[#D4AF37] font-serif text-xl mb-4">Infusion</h4>
                      <p className="text-gray-400 font-light leading-relaxed">Une infusion à froid (laisser les grains 24h au frigo dans le liquide) développe des arômes encore plus subtils.</p>
                    </TabsContent>
                  </div>
                </Tabs>
              </div>
